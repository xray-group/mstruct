...
\label{a00015}\index{Obj\-Cryst\-::\-Atom@{Obj\-Cryst\-::\-Atom}}
...
\begin{DoxyCompactList}\small\item\em \doxyref{Atom}{p.}{a00015} constructor. \end{DoxyCompactList}\item 
{\bf Atom} (const {\bf Atom} \&old)\label{a00015_a4882db30ef33e70582b354db8e76a07c}

\begin{DoxyCompactList}\small\item\em Copy constructor. \end{DoxyCompactList}\item 
virtual {\bf Atom} $\ast$ {\bf Create\-Copy} () const 
\item 
{\bf $\sim$\-Atom} ()\label{a00015_a86039a28098c9b48e7f4f57636a7e55d}
...
virtual void {\bfseries operator=} (const {\bf Atom} \&rhs)\label{a00015_afc87e2009e5a0ad02311ff072b4f3b3e}
...
virtual int {\bf Get\-Nb\-Component} () const \label{a00015_a7739a016c88ab32355e67b1c03fe97f0}
...
virtual void {\bf Print} () const \label{a00015_a6c6836c4aa9d1510d64c7916d6ad47e2}
...
\item 
bool {\bf Is\-Dummy} () const \label{a00015_a672b84cd14db777c2f449d52671a3b15}

\begin{DoxyCompactList}\small\item\em Is this a dummy atom ? (ie no \doxyref{Scattering\-Power}{p.}{a00097}) Dummy atoms should not exist ! \end{DoxyCompactList}\item 
...
const {\bf Scattering\-Power} \& {\bf Get\-Scattering\-Power} () const \label{a00015_a63893a902cb731f552cb573c58ec94bb}

\begin{DoxyCompactList}\small\item\em Get the \doxyref{Scattering\-Power\-Atom}{p.}{a00098} corresponding to this atom. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
virtual void {\bf Init\-Ref\-Par\-List} ()\label{a00015_a72fe4868d70c8068483ba635029bbc86}
...
\begin{DoxyCompactItemize}
\item 
{\bf Scattering\-Component\-List} {\bf m\-Scatt\-Comp\-List}\label{a00015_aa9fc76a4412ca0726a478612caf02ead}

\begin{DoxyCompactList}\small\item\em The list of scattering components. \end{DoxyCompactList}\item 
const {\bf Scattering\-Power} $\ast$ {\bf mp\-Scatt\-Pow\-Atom}\label{a00015_a2ca524de2384b4beb111db9ed789f9fc}

\begin{DoxyCompactList}\small\item\em The \doxyref{Scattering\-Power\-Atom}{p.}{a00098} associated to that atom. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This class records the position of the atom, and has a pointer to its \doxyref{Scattering\-Power\-Atom}{p.}{a00098}.

\begin{DoxyNote}{Note}
there can be 'Dummy' atoms, for which the used symbol is \char`\"{}\-X\char`\"{}, and which have no scattering power (use with caution\-: dummy atoms are only supposed to be used within \doxyref{Z\-Scatterer}{p.}{a00163}) 
\end{DoxyNote}
...
)}\label{a00015_afa78c541a05f1210e9913c4591752042}


Default constructor. 

The \doxyref{Atom}{p.}{a00015} {\itshape must} be initialized thereafter using \doxyref{Atom\-::\-Init()}{p.}{a00015_ab05ef76113333041255789dba4bb60cd} \index{Obj\-Cryst\-::\-Atom@{Obj\-Cryst\-::\-Atom}!Atom@{Atom}}
\index{Atom@{Atom}!ObjCryst::Atom@{Obj\-Cryst\-::\-Atom}}
\paragraph[{Atom}]{\setlength{\rightskip}{0pt plus 5cm}Obj\-Cryst\-::\-Atom\-::\-Atom (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\label{a00015_a8f37e515c9e847ba20cc1033cd54e7b8}
...
\hline
{\em pow} & \-: the \doxyref{Scattering\-Power}{p.}{a00097} associated to this atom. Must be allocated separately. \\
\hline
...
\end{DoxyParamCaption}
)}\label{a00015_a1a4253d4b5ea4d8777963a43c7817e87}
...
{\em x,y,z} & \-: {\itshape fractional} coordinates of the atom \\
\hline
{\em popu} & \-: the population of the atom (0.\-0-\/$>$1.\-0) This should take into account the multiplicity of the atom. For an atom in group P2 and on the 2 axis, this should be set to 0.\-5, {\bfseries unless} you are using the dynamical occupancy correction (recommended for global optimizations). See \doxyref{Crystal\-::\-Calc\-Dyn\-Pop\-Corr()}{p.}{a00027_a69975008974c9603ebb794bb6bb20fe8} and \doxyref{Crystal\-::m\-Use\-Dyn\-Pop\-Corr}{p.}{a00027_aa75ade2fea9a50b3e6fb08773f607a13}\\
\hline
{\em pow} & \-: the \doxyref{Scattering\-Power}{p.}{a00097} associated to this atom. Must be allocated separatly. \\
\hline
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_af5215404ae1f180ed84046700845f92a}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a9f0d1cb7c3b1db1baf84076e5da0ca0e}
...
\item[{const int}]{i}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a88fed92945210af0e6cf28e34fa545f4}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a01645142310cf68d21b50ec514a0af77}
...
{}
\end{DoxyParamCaption}
) const}\label{a00015_afbdf315ca2363179e5227fe47d7f9106}


Returns the molar mass of the atom. 

Values are extracted from the 'atominfo' package, which uses data from the C\-R\-C Handbook of Chemistry \& Physics, 63rd \& 70th editions The Mass is actually extracted from the \doxyref{Scattering\-Power\-Atom}{p.}{a00098}. \index{Obj\-Cryst\-::\-Atom@{Obj\-Cryst\-::\-Atom}!Get\-Radius@{Get\-Radius}}
...
{}
\end{DoxyParamCaption}
) const}\label{a00015_ac0e9f074ecf5a20cf73752d38d7cc453}


Returns the radius (in Angstroems) of the atom. 

Values are extracted from the 'atominfo' package, which uses data from the I\-C\-S\-D/\-C\-R\-Y\-S\-T\-I\-N Manual The Radius is extracted from the \doxyref{Scattering\-Power\-Atom}{p.}{a00098}. \index{Obj\-Cryst\-::\-Atom@{Obj\-Cryst\-::\-Atom}!Get\-Scattering\-Component\-List@{Get\-Scattering\-Component\-List}}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a3483660b1d08b113af61d708ecff8d1a}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a14e239415f6923d83ceff1347b89393b}
...
\end{DoxyParamCaption}
)}\label{a00015_ab05ef76113333041255789dba4bb60cd}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a2994321bc2974d853f36b011d23a94b3}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a08fe773b05dd0dc748b8008636b56187}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00015_a83bd4047affa8c4de3126465595b77cb}
