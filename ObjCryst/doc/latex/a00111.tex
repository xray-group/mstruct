...
\label{a00111}\index{Obj\-Cryst\-::\-Texture\-March\-Dollase@{Obj\-Cryst\-::\-Texture\-March\-Dollase}}
...
\item 
{\bfseries Texture\-March\-Dollase} (const {\bf Scattering\-Data} \&data)\label{a00111_a68c09384efe47c70c8f43fb877dfc571}

\item 
virtual const string \& {\bf Get\-Name} () const \label{a00111_a8be04714cbb7f98307fa90b044360e35}

\begin{DoxyCompactList}\small\item\em Get the name of this object. \end{DoxyCompactList}\item 
virtual const string \& {\bf Get\-Class\-Name} () const \label{a00111_a2b1002c1ed071f53b2a6f1b953527cc2}

\begin{DoxyCompactList}\small\item\em Get the name of the class. \end{DoxyCompactList}\item 
void {\bfseries Add\-Phase} (const R\-E\-A\-L fraction, const R\-E\-A\-L coeff\-March, const R\-E\-A\-L h, const R\-E\-A\-L k, const R\-E\-A\-L l)\label{a00111_a88fe286c7547b841edecc905b1a95b84}

\item 
void {\bfseries Set\-Phase\-Par} (const unsigned int i, const R\-E\-A\-L fraction, const R\-E\-A\-L coeff\-March, const R\-E\-A\-L h, const R\-E\-A\-L k, const R\-E\-A\-L l)\label{a00111_ae5cb3330830822cb4ce7d23083296c53}

\item 
void {\bfseries Delete\-Phase} (const unsigned int i)\label{a00111_a7290f7949ee2c4e302017f24d3994da1}

\item 
unsigned int {\bfseries Get\-Nb\-Phase} () const \label{a00111_ae3f55de726d50dbf86d7daa4c629a7df}

\item 
R\-E\-A\-L {\bfseries Get\-Fraction} (const unsigned int i) const \label{a00111_a02e5f7f948832765eba593759c62dcb4}

\item 
R\-E\-A\-L {\bfseries Get\-March\-Coeff} (const unsigned int i) const \label{a00111_ae2f4479ae167d57ab66d952bb9fa8702}

\item 
R\-E\-A\-L {\bfseries Get\-Phase\-H} (const unsigned int i) const \label{a00111_af93dff2dfc82d85dd1d6b6e343fc20e0}

\item 
R\-E\-A\-L {\bfseries Get\-Phase\-K} (const unsigned int i) const \label{a00111_a33eba37e0060eb34ea56fe997886966f}

\item 
R\-E\-A\-L {\bfseries Get\-Phase\-L} (const unsigned int i) const \label{a00111_a39111e8d14fe437bc5638909fe9b50bf}
...
virtual R\-E\-A\-L {\bfseries Get\-Biasing\-Cost} () const \label{a00111_a37b873011cdb7443876f2954a00d1fe1}
...
\begin{DoxyCompactItemize}
\item 
virtual void {\bf Calc\-Corr} () const \label{a00111_a1c2c3c1fe88571b2a5b771ab86128240}

\begin{DoxyCompactList}\small\item\em Do the computation of corrected intensities. \end{DoxyCompactList}\item 
void {\bfseries Delete\-All\-Phase} ()\label{a00111_a2c81cc2848f052c2900d135631a7e5ba}
...
\item 
{\bf Obj\-Registry}\\*
$<$ {\bf Texture\-Phase\-March\-Dollase} $>$ {\bfseries m\-Phase\-Registry}\label{a00111_a5036a20bd0edc8c003c317ca3d11bd85}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Texture\-Par}\label{a00111_aa2c0a0db3b5c9178d1d61125ac72349e}
...
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00111_a73f6148d035bbdeb98b0115d76fe48a8}
...
\doxyref{End\-Optimization()}{p.}{a00078_ab0035f6164cb24ace67b51b11993a851} must be called at the end of the optimization, the same number of time \doxyref{Begin\-Optimization()}{p.}{a00111_a73f6148d035bbdeb98b0115d76fe48a8} was called !
\end{DoxyNote}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00111_a43d8d96c3f14d9d01145dfbefb759e6a}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00111_a972d51af36bfd317f794c87841c58b5a}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00111_a26ae81ce2e09c173d200c9a61cb67161}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00111_a09d994c3344a276ba65563fb9f1b45ca}
...
\paragraph[{m\-Nb\-Refl\-Used}]{\setlength{\rightskip}{0pt plus 5cm}unsigned long Obj\-Cryst\-::\-Texture\-March\-Dollase\-::m\-Nb\-Refl\-Used\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00111_a243ea853b7d3179f9474386ed296783c}


Number of reflexion for which the calculation is actually done. 

This is automaticaly updated during Calc\-Corr, from the parent \doxyref{Scattering\-Data\-::\-Get\-Max\-Sin\-Theta\-Ov\-Lambda()}{p.}{a00096_ad682b6879c751fd4d241a198b1893e6e} 
