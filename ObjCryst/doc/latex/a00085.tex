...
\label{a00085}\index{Obj\-Cryst\-::\-Ref\-Obj\-Opt@{Obj\-Cryst\-::\-Ref\-Obj\-Opt}}
...
void {\bfseries Init} (const int nb\-Choice, const string $\ast$name, const string $\ast$choice\-Names)\label{a00085_acb2124833f426224863027d1f3f0e9d6}

\item 
int {\bfseries Get\-Nb\-Choice} () const \label{a00085_aeee7a18a06caf2e9de43f195c7ecee00}

\item 
int {\bfseries Get\-Choice} () const \label{a00085_a9c4ccafc994514e39266a1b6d91e1f42}

\item 
virtual void {\bfseries Set\-Choice} (const int choice)\label{a00085_a0333cbcd6ff10a2ee9aae0bafd3770c5}

\item 
void {\bfseries Set\-Choice} (const string \&choice\-Name)\label{a00085_a9a92c1a5543e46119687462a1b7e706e}

\item 
const string \& {\bfseries Get\-Name} () const \label{a00085_ab0bd1fc64b59914f2b8596f5537ecd67}

\item 
const string \& {\bfseries Get\-Class\-Name} () const \label{a00085_ad2d43141d9d301527bf134ff5c4f34f0}

\item 
const string \& {\bfseries Get\-Choice\-Name} (const int i) const \label{a00085_ae00a732dceaa596d2129805a44bcdddc}

\item 
const {\bf Refinable\-Obj\-Clock} \& {\bfseries Get\-Clock} () const \label{a00085_a6c019a9936024016dc5704f93c117424}
...
\begin{DoxyCompactItemize}
\item 
int {\bf m\-Nb\-Choice}\label{a00085_a54ae7b002c156671d5b2176a46cf95d5}

\begin{DoxyCompactList}\small\item\em Number of different choice possible for this option. \end{DoxyCompactList}\item 
int {\bf m\-Choice}\label{a00085_a34f40080b3adac88e5ab7e290dc951ae}
...
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock}\label{a00085_ace306a0100bbb1678c9b8683a009dc81}
...
)}\label{a00085_ad4fd60241264e22179c9ab33fc58867f}
...
\end{DoxyParamCaption}
)}\label{a00085_a9562e469ee61a710e535594fe58f0744}
...
\end{DoxyParamCaption}
) const}\label{a00085_a5758abdb2557b2b2a2621e015fd8ad75}
...
\paragraph[{mp\-Choice\-Name}]{\setlength{\rightskip}{0pt plus 5cm}const string$\ast$ Obj\-Cryst\-::\-Ref\-Obj\-Opt\-::mp\-Choice\-Name\hspace{0.3cm}{\ttfamily [protected]}}\label{a00085_abc47d0f345c4121b6492e754b30f4fef}
...
\paragraph[{mp\-Name}]{\setlength{\rightskip}{0pt plus 5cm}const string$\ast$ Obj\-Cryst\-::\-Ref\-Obj\-Opt\-::mp\-Name\hspace{0.3cm}{\ttfamily [protected]}}\label{a00085_a45eb6eed7f6578f438433acddb2f1eb2}
