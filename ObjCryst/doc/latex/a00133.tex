...
\label{a00133}\index{Obj\-Cryst\-::\-W\-X\-Field\-String@{Obj\-Cryst\-::\-W\-X\-Field\-String}}
...
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{a00133}
\end{center}
\end{figure}
\subsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
{\bfseries W\-X\-Field\-String} (wx\-Window $\ast$parent, string \&st, const int field\-\_\-id, const int hsize=50, bool is\-Editable=true)\label{a00133_ac4c30cbc2b61cd29f864e8b6853474d4}
...
void {\bf On\-Text} (wx\-Command\-Event \&W\-X\-U\-N\-U\-S\-E\-D(event))\label{a00133_a0c9a4f6f2c3c1082ba3aff0fa55d19f3}
...
const string {\bf Get\-Value} () const \label{a00133_a488ed5b180ffd0dea95624c02962ab35}
...
void {\bf Revert} ()\label{a00133_a0372d3d98cad5236fc2ebb628c881600}
...
virtual void {\bf Validate\-User\-Input} ()\label{a00133_a37e535d0725ecfdb59795363f1472c90}
...
virtual void {\bf Set\-Size} (int width, int height)\label{a00133_ac263b80aafdff3bb56187427445b27c7}

\begin{DoxyCompactList}\small\item\em Change the size of the field (excluding the title) \end{DoxyCompactList}\item 
virtual void {\bf Set\-Tool\-Tip} (const wx\-String \&tip)\label{a00133_a861f4019069a28ab6d70c87157d832f1}
...
\begin{DoxyCompactItemize}
\item 
string $\ast$ {\bf mp\-String}\label{a00133_af0a4daf786fad26b6bd9939426fdb94a}

\begin{DoxyCompactList}\small\item\em The \doxyref{W\-X\-Cryst\-Obj}{p.}{a00122} whose name is shown here. \end{DoxyCompactList}\item 
string {\bf m\-Value}\label{a00133_a9e283fe8a42b5935bb5c21a7adf17edd}

\begin{DoxyCompactList}\small\item\em Last name displayed. \end{DoxyCompactList}\item 
wx\-Text\-Ctrl $\ast$ {\bf mp\-Field}\label{a00133_aa76720da6e7e99c814a6566a54c7b644}
...
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00133_af10eb2c5beb34a1bae3175b04149e39d}


Get new values to be displayed from the underlying object, and raise flag if an U\-I update is necessary. 

The actual G\-U\-I update is not made here. \doxyref{Update\-U\-I()}{p.}{a00133_ad2a636e69047cf9f4f3610515aa53666} should be called separately, from the main thread.


\begin{DoxyParams}{Parameters}
{\em update\-U\-I,\-:} & if true, this will call Update\-U\-I, either directly (if in the main thread), or by sending a message. \\
\hline
{\em mutexlock,\-:} & if true, a Mutex will be used to lock the data shared between main and background thread. The idea is to only use a few Mutexes to lock data from the top objects (wx\-Refinable\-Obj,...), when calling \doxyref{Cryst\-Update()}{p.}{a00133_af10eb2c5beb34a1bae3175b04149e39d} and \doxyref{Update\-U\-I()}{p.}{a00133_ad2a636e69047cf9f4f3610515aa53666}. As sub-\/objects (\doxyref{W\-X\-Field}{p.}{a00126},...) are only updated from within a top object, the mutex lock in the top object will also lock the data in the sub-\/objects. \\
\hline
\end{DoxyParams}
...
\end{DoxyParamCaption}
)}\label{a00133_a4ab041e7f333884f0bfb8371699a47ad}
...
\item[{const string \&}]{}
\end{DoxyParamCaption}
)}\label{a00133_a26889c2974269016abf0ed81c860ca29}
...
\item[{const bool}]{mutexlock = {\ttfamily false}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00133_ad2a636e69047cf9f4f3610515aa53666}
...
\hline
\end{DoxyParams}
The idea is to only use a few Mutexes to lock data from the top objects (wx\-Refinable\-Obj,...), when calling \doxyref{Cryst\-Update()}{p.}{a00133_af10eb2c5beb34a1bae3175b04149e39d} and \doxyref{Update\-U\-I()}{p.}{a00133_ad2a636e69047cf9f4f3610515aa53666}. As sub-\/objects (\doxyref{W\-X\-Field}{p.}{a00126},...) are only updated from within a top object, the mutex lock in the top object will also lock the data in the sub-\/objects. 
...
\paragraph[{m\-Is\-Self\-Updating}]{\setlength{\rightskip}{0pt plus 5cm}bool Obj\-Cryst\-::\-W\-X\-Field\-String\-::m\-Is\-Self\-Updating\hspace{0.3cm}{\ttfamily [protected]}}\label{a00133_aa22ef2e61af183c448dabe73b98d367e}
...
\paragraph[{m\-Value\-Old}]{\setlength{\rightskip}{0pt plus 5cm}string Obj\-Cryst\-::\-W\-X\-Field\-String\-::m\-Value\-Old\hspace{0.3cm}{\ttfamily [protected]}}\label{a00133_a3764d3f904c5e3709be04a97cc0a1e2b}
