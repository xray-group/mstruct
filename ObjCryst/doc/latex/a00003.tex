...
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
-\/$>$ {\bfseries POOMA} ({\tt http://www.acl.lanl.gov/pooma/})Parallel Object-\/Oriented Methods and Applications 
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
