...
\label{a00062}\index{Obj\-Cryst\-::\-Optimization\-Obj@{Obj\-Cryst\-::\-Optimization\-Obj}}
...
\begin{DoxyCompactItemize}
\item 
{\bf Optimization\-Obj} (const string name=\char`\"{}\char`\"{})\label{a00062_a939444ac47768e16d205bebbc247cc12}

\begin{DoxyCompactList}\small\item\em Constructor. \end{DoxyCompactList}\item 
virtual {\bf $\sim$\-Optimization\-Obj} ()\label{a00062_a6fdf1e7158254a3c0a21b33e6ed5ffb5}
...
void {\bf Fix\-All\-Par} ()\label{a00062_af8b3cef84c6bcca37cdc4bfde9ecde45}

\begin{DoxyCompactList}\small\item\em Fix all parameters. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Fixed} (const string \&par\-Name, const bool fix)\label{a00062_aca3e1d2c6ace92f1a3a67da2455eac39}

\begin{DoxyCompactList}\small\item\em Fix one parameter. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Fixed} (const {\bf Ref\-Par\-Type} $\ast$type, const bool fix)\label{a00062_a12a66416a701cbf0db17de3bfafdec99}

\begin{DoxyCompactList}\small\item\em Fix one family of parameters. \end{DoxyCompactList}\item 
void {\bf Un\-Fix\-All\-Par} ()\label{a00062_adb016adacaa7a2a15e40cfb746705bdd}

\begin{DoxyCompactList}\small\item\em Un\-Fix All parameters. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Used} (const string \&par\-Name, const bool use)\label{a00062_ab2f87becfb73eb00d8f7c3ff25435c0d}

\begin{DoxyCompactList}\small\item\em Set a parameter to be used. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Used} (const {\bf Ref\-Par\-Type} $\ast$type, const bool use)\label{a00062_a73c29f094ad0a4923a2873388fc1eb93}

\begin{DoxyCompactList}\small\item\em Set a family of parameters to be used. \end{DoxyCompactList}\item 
void {\bf Set\-Limits\-Relative} (const string \&par\-Name, const R\-E\-A\-L min, const R\-E\-A\-L max)\label{a00062_a78113a7741eeda2263a27adcc24497c0}

\begin{DoxyCompactList}\small\item\em Change the relative limits for a parameter from its name. \end{DoxyCompactList}\item 
void {\bf Set\-Limits\-Relative} (const {\bf Ref\-Par\-Type} $\ast$type, const R\-E\-A\-L min, const R\-E\-A\-L max)\label{a00062_a0437fb441bebe91879de98efcb82865e}

\begin{DoxyCompactList}\small\item\em Change the relative limits for a family of parameter. \end{DoxyCompactList}\item 
void {\bf Set\-Limits\-Absolute} (const string \&par\-Name, const R\-E\-A\-L min, const R\-E\-A\-L max)\label{a00062_ad0bc0b36d1525526c55dc6642109d0b4}

\begin{DoxyCompactList}\small\item\em Change the absolute limits for a parameter from its name. \end{DoxyCompactList}\item 
void {\bf Set\-Limits\-Absolute} (const {\bf Ref\-Par\-Type} $\ast$type, const R\-E\-A\-L min, const R\-E\-A\-L max)\label{a00062_ade59b2e1d698ff7ba93ac5aa88187c58}
...
void {\bf Stop\-After\-Cycle} ()\label{a00062_a288306acc3189c4fcaca398d11b32e4e}
...
virtual void {\bf Display\-Report} ()\label{a00062_af09e8a9cd1b7f7f29bf57d027e08fc54}
...
void {\bf Add\-Refinable\-Obj} ({\bf Refinable\-Obj} \&)\label{a00062_a05e7019188763202126f9f83a31e1673}
...
\begin{DoxyCompactList}\small\item\em Get the \doxyref{Refinable\-Obj}{p.}{a00078} with all the parameters from all refined objects. \end{DoxyCompactList}\item 
...
const string \& {\bf Get\-Name} () const \label{a00062_af595745274e554956834f885d7a1dc71}

\begin{DoxyCompactList}\small\item\em Get the name for this object. \end{DoxyCompactList}\item 
void {\bf Set\-Name} (const string \&)\label{a00062_a076dc80d878fc4ab5e5491f54642382e}

\begin{DoxyCompactList}\small\item\em Set the name for this object. \end{DoxyCompactList}\item 
virtual const string {\bf Get\-Class\-Name} () const \label{a00062_a2f00b2c3eb874d966bbb778a0d81abb1}

\begin{DoxyCompactList}\small\item\em Get the name for this class type. \end{DoxyCompactList}\item 
virtual void {\bf Print} () const \label{a00062_a55e92db45821ed13288d6852055c0003}

\begin{DoxyCompactList}\small\item\em Print some information about this object. \end{DoxyCompactList}\item 
void {\bf Restore\-Best\-Configuration} ()\label{a00062_a25a4ea1cf717a7d62ecf2cdbee87fa7a}

\begin{DoxyCompactList}\small\item\em Restore the Best configuration. \end{DoxyCompactList}\item 
bool {\bf Is\-Optimizing} () const \label{a00062_a02d12183cd9d167358717b87ada6ba1f}

\begin{DoxyCompactList}\small\item\em Are we busy optimizing ? \end{DoxyCompactList}\item 
void {\bf Tag\-New\-Best\-Config} ()\label{a00062_a99ca4e2216b0fd93ab335c35a99ca895}
...
R\-E\-A\-L {\bf Get\-Last\-Optim\-Elapsed\-Time} () const \label{a00062_af9bb37804ee3012cb05ffc217584db42}
...
{\bf Main\-Tracker} \& {\bf Get\-Main\-Tracker} ()\label{a00062_af8328b810bc37e45881e19948da7d2d7}

\begin{DoxyCompactList}\small\item\em Get the \doxyref{Main\-Tracker}{p.}{a00048}. \end{DoxyCompactList}\item 
const {\bf Main\-Tracker} \& {\bf Get\-Main\-Tracker} () const \label{a00062_a737490fc1ac0b30fc3bb3a5bb8061a8b}

\begin{DoxyCompactList}\small\item\em Get the \doxyref{Main\-Tracker}{p.}{a00048}. \end{DoxyCompactList}\item 
{\bf Ref\-Obj\-Opt} \& {\bfseries Get\-X\-M\-L\-Auto\-Save\-Option} ()\label{a00062_a82e4adbc7b5d3374f7c414a0e89c25fd}

\item 
const {\bf Ref\-Obj\-Opt} \& {\bfseries Get\-X\-M\-L\-Auto\-Save\-Option} () const \label{a00062_a0a37e6bcce21926e13a3f57882e971b0}

\item 
const R\-E\-A\-L \& {\bf Get\-Best\-Cost} () const \label{a00062_a56c9ec94e7632c8b3f36e3a837c02594}

\begin{DoxyCompactList}\small\item\em Access to current best cost. \end{DoxyCompactList}\item 
R\-E\-A\-L \& {\bf Get\-Best\-Cost} ()\label{a00062_a894882f10bd768e3e57ffdfa9f9df7fe}

\begin{DoxyCompactList}\small\item\em Access to current best cost. \end{DoxyCompactList}\item 
virtual void {\bf Begin\-Optimization} (const bool allow\-Approximations=false, const bool enable\-Restraints=false)\label{a00062_a13c12dbdc72825f892c3d48dd2b6cfe3}

\begin{DoxyCompactList}\small\item\em Begin optimization for all objects. \end{DoxyCompactList}\item 
virtual void {\bf End\-Optimization} ()\label{a00062_a37c2335ad867152121253996daaebc6e}
...
\item 
virtual void {\bf Init\-Options} ()\label{a00062_a0d7f6ae8f6ef49b59f0bc5b4794931e9}
...
\begin{DoxyCompactList}\small\item\em (Re)build \doxyref{Optimization\-Obj\-::m\-Recursive\-Refined\-Obj\-List}{p.}{a00062_a0e6a9e9d4d12ed73c582da36190f110f}, if an object has been added or modified. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
string {\bf m\-Name}\label{a00062_a9fa42c95df26834a9f369af61eb10ea6}

\begin{DoxyCompactList}\small\item\em Name of the Global\-Optimization object. \end{DoxyCompactList}\item 
string {\bf m\-Save\-File\-Name}\label{a00062_a2694dd9fc6ab088e3d79e0c9e0358311}
...
long {\bf m\-Nb\-Trial}\label{a00062_af47650ca783520dd0100077b08271c79}

\begin{DoxyCompactList}\small\item\em Number of trials so far. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf m\-Best\-Cost}\label{a00062_a495926a48dd408a3b92de8a6b33f815a}

\begin{DoxyCompactList}\small\item\em Best value of the cost function so far. \end{DoxyCompactList}\item 
long {\bf m\-Best\-Par\-Saved\-Set\-Index}\label{a00062_aa9c2d238f7b60c7ea3bd715bf145b5d3}

\begin{DoxyCompactList}\small\item\em Index of the 'best' saved parameter set. \end{DoxyCompactList}\item 
unsigned long {\bf m\-Context}\label{a00062_a7139f75c5b214ea00f99c2e4c25b2b34}
...
{\bf Refinable\-Obj} \\*
$\ast$, {\bf Log\-Likelihood\-Stats} $>$ $>$ {\bf mv\-Context\-Obj\-Stats}\label{a00062_a1b33baa71f4e0b182bae66766608425f}
...
$\ast$, Dynamic\-Obj\-Weight $>$ {\bf mv\-Obj\-Weight}\label{a00062_a4b1120b0a6fc24c82c273152722f672c}
...
bool {\bf m\-Is\-Optimizing}\label{a00062_a712048cd592825ce31ced1120733345b}
...
bool {\bf m\-Stop\-After\-Cycle}\label{a00062_abec493a46c9e57c7e71e886bcae601fb}
...
{\bf Obj\-Registry}$<$ {\bf Refinable\-Obj} $>$ {\bf m\-Refined\-Obj\-List}\label{a00062_a73f491b5c8a0ae5f087e496916f76016}
...
{\bf Ref\-Obj\-Opt} {\bf m\-X\-M\-L\-Auto\-Save}\label{a00062_a94038e1c477b1efa6417c13106d6bc89}

\begin{DoxyCompactList}\small\item\em Periodic save of complete environment as an xml file. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf m\-Last\-Optim\-Time}\label{a00062_abf309e1b2248a7e1d3744d4b20d15bfd}
...
\begin{DoxyCompactList}\small\item\em \doxyref{Main\-Tracker}{p.}{a00048} object to track the evolution of cost functions, likelihood, and individual parameters. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
)\hspace{0.3cm}{\ttfamily [protected]}}\label{a00062_a7c819c5f8fc52caafd97ea9d468da2be}


(Re)build \doxyref{Optimization\-Obj\-::m\-Recursive\-Refined\-Obj\-List}{p.}{a00062_a0e6a9e9d4d12ed73c582da36190f110f}, if an object has been added or modified. 
...
\end{DoxyParamCaption}
)}\label{a00062_afef162d94382a93fe037fac1b5d3ef03}


Get the \doxyref{Refinable\-Obj}{p.}{a00078} with all the parameters from all refined objects. 
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00062_a0f317f235e6e5cb1867cc7c5870f510f}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00062_aa53575dbda2ec3f561bed934beb4ca6f}
...
Implemented in {\bf Obj\-Cryst\-::\-Monte\-Carlo\-Obj} \doxyref{}{p.}{a00057_ae1689aa2dd5867499768328df935334d}, and {\bf Obj\-Cryst\-::\-Simplex\-Obj} \doxyref{}{p.}{a00100_a1c7ae823f9e31169b453f36d15c049b8}.
...
\item[{const R\-E\-A\-L}]{max\-Time = {\ttfamily -\/1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00062_a08c77dc6ec80f63bf067ef2968a0b6dc}
...
Implemented in {\bf Obj\-Cryst\-::\-Monte\-Carlo\-Obj} \doxyref{}{p.}{a00057_aef060de8a302fb8c4e607e00667d7b49}, and {\bf Obj\-Cryst\-::\-Simplex\-Obj} \doxyref{}{p.}{a00100_aa8bf4b209e2ce6229722b18ec9911010}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{a00062_a2f11f520bc1bd0b70f8aea98d3f8224c}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00062_a04ac9f4d67eb8823b78b00f222a5a29c}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00062_a3658f0e6232756d68b8b17256f27a9bd}


Update Display (if any display is available), when a new 'relevant' configuration is reached. 

This calls all \doxyref{Refinable\-Obj\-::\-Update\-Display()}{p.}{a00078_ab74e2cead734fe1e652c5add46c5e116} \index{Obj\-Cryst\-::\-Optimization\-Obj@{Obj\-Cryst\-::\-Optimization\-Obj}!X\-M\-L\-Input@{X\-M\-L\-Input}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00062_aa07aee60f56780e2c56fb20f4a5f48a8}
...
Implemented in {\bf Obj\-Cryst\-::\-Monte\-Carlo\-Obj} \doxyref{}{p.}{a00057_a2f9428857b1d26bbdac08d59debb9f52}, and {\bf Obj\-Cryst\-::\-Simplex\-Obj} \doxyref{}{p.}{a00100_ae6ed0602ffdd2db1a10be80820a0a285}.
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00062_a6b7726159bb0d5dad1c7eebaee78f53a}
...
Implemented in {\bf Obj\-Cryst\-::\-Monte\-Carlo\-Obj} \doxyref{}{p.}{a00057_a619eb171e5fe384be4d37f999dde8e0f}, and {\bf Obj\-Cryst\-::\-Simplex\-Obj} \doxyref{}{p.}{a00100_a7111042ca3a7201039a25fe548cb524c}.
...
\paragraph[{m\-Main\-Tracker}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Main\-Tracker} Obj\-Cryst\-::\-Optimization\-Obj\-::m\-Main\-Tracker\hspace{0.3cm}{\ttfamily [protected]}}\label{a00062_abe2f9a9812abe0f4a6c414457b5b2967}


\doxyref{Main\-Tracker}{p.}{a00048} object to track the evolution of cost functions, likelihood, and individual parameters. 
...
\paragraph[{m\-Recursive\-Refined\-Obj\-List}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Obj\-Registry}$<${\bf Refinable\-Obj}$>$ Obj\-Cryst\-::\-Optimization\-Obj\-::m\-Recursive\-Refined\-Obj\-List\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00062_a0e6a9e9d4d12ed73c582da36190f110f}
...
\paragraph[{m\-Ref\-Par\-List}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Refinable\-Obj} Obj\-Cryst\-::\-Optimization\-Obj\-::m\-Ref\-Par\-List\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00062_a9cf13c38f24b4b2ddd6cb239286053af}
...
\paragraph[{mv\-Saved\-Param\-Set}]{\setlength{\rightskip}{0pt plus 5cm}std\-::vector$<$pair$<$long,R\-E\-A\-L$>$ $>$ Obj\-Cryst\-::\-Optimization\-Obj\-::mv\-Saved\-Param\-Set\hspace{0.3cm}{\ttfamily [protected]}}\label{a00062_a9063bb2fa6a6f0938295be2ffe2bfe84}
