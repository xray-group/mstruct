...
\label{a00106}\index{Obj\-Cryst\-::\-Stretch\-Mode\-Bond\-Length@{Obj\-Cryst\-::\-Stretch\-Mode\-Bond\-Length}}
...
\item 
{\bf Stretch\-Mode\-Bond\-Length} ({\bf Mol\-Atom} \&at0, {\bf Mol\-Atom} \&at1, const {\bf Mol\-Bond} $\ast$p\-Bond)\label{a00106_aa04e0fdc910b1fcbb25de4de51d32455}
...
virtual void {\bf Print} (ostream \&os, bool full=true) const \label{a00106_a37f862548c4540b2a34d435a18518564}

\begin{DoxyCompactList}\small\item\em Print one-\/line list of atoms moved. \end{DoxyCompactList}\item 
virtual void {\bf Stretch} (const R\-E\-A\-L change)\label{a00106_a65db454973b827a24f5ef35e654650ea}

\begin{DoxyCompactList}\small\item\em Move the atoms according to this mode. \end{DoxyCompactList}\item 
virtual void {\bf Random\-Stretch} (const R\-E\-A\-L amplitude)\label{a00106_a41e0165a10a248a1af200e217739e585}
...
\begin{DoxyCompactItemize}
\item 
{\bf Mol\-Atom} $\ast$ {\bf mp\-Atom0}\label{a00106_a3ddf1478c2b932ad976d33eda56dd35a}

\begin{DoxyCompactList}\small\item\em The first atom (fixed). \end{DoxyCompactList}\item 
{\bf Mol\-Atom} $\ast$ {\bf mp\-Atom1}\label{a00106_aef858d1c7ca2ee9c09e88f8464337b31}

\begin{DoxyCompactList}\small\item\em The second atom (first atom moved) \end{DoxyCompactList}\item 
const {\bf Mol\-Bond} $\ast$ {\bf mp\-Bond}\label{a00106_a6fc92ed5334db0589d860f32254cac93}
...
set$<$ {\bf Mol\-Atom} $\ast$ $>$ {\bf mv\-Translated\-Atom\-List}\label{a00106_ac18eef8c47f6ac752c00f1f93216a6ee}
...
This should be merged (or have an inheritance relation) with \doxyref{Mol\-Bond}{p.}{a00051}. 
...
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00106_a72bab02ebf84cbf65cf2703e74c1e02e}
