...
\label{a00076}\index{Obj\-Cryst\-::\-Radiation@{Obj\-Cryst\-::\-Radiation}}
...
\item 
{\bf Radiation} ()\label{a00076_abd533ac660e70618339636f18d1347f4}
...
{\bf Radiation} (const {\bf Radiation} \&)\label{a00076_ab08e37b8dd00149612aa656f1641a76f}
...
void {\bfseries operator=} (const {\bf Radiation} \&)\label{a00076_aaa4a0199b2d383fb69c0de13c62a024c}

\item 
{\bf Radiation\-Type} {\bf Get\-Radiation\-Type} () const \label{a00076_a3c4e81e8db0ea43c42278948c56ba46f}

\begin{DoxyCompactList}\small\item\em Get the radiation type (X-\/\-Rays, Neutron) \end{DoxyCompactList}\item 
void {\bf Set\-Radiation\-Type} (const {\bf Radiation\-Type})\label{a00076_a8fd969b9f546fc48f5bfd7b38ff9c995}

\begin{DoxyCompactList}\small\item\em Set the radiation type (X-\/\-Rays, Neutron) \end{DoxyCompactList}\item 
void {\bf Set\-Wavelength\-Type} (const {\bf Wavelength\-Type} \&type)\label{a00076_adc4fac12bb11e01e515365e5d7a46ddc}
...
{\bf Wavelength\-Type} {\bf Get\-Wavelength\-Type} () const \label{a00076_ab1c21d1a6344287a8c4271c2b7a12c79}
...
void {\bf Set\-Wavelength} (const R\-E\-A\-L)\label{a00076_ac40cb0879be00b232a6c3e78c069823d}
...
R\-E\-A\-L {\bf Get\-X\-Ray\-Tube\-Delta\-Lambda} () const \label{a00076_aaacaaa8568c368b0f39d4ee8cea95576}

\begin{DoxyCompactList}\small\item\em Get the wavelength difference for Alpha1 and Alpha2. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf Get\-X\-Ray\-Tube\-Alpha2\-Alpha1\-Ratio} () const \label{a00076_aa2016f3b8df9727cc59d74f137f2c626}

\begin{DoxyCompactList}\small\item\em Get the Kalpha2/\-Kalpha1 ratio. \end{DoxyCompactList}\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Wavelength} () const \label{a00076_a049b5bed7c75b14ad1e5e84ff945b7fa}

\begin{DoxyCompactList}\small\item\em Last time the wavelength has been changed. \end{DoxyCompactList}\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Radiation} () const \label{a00076_ac3085d33817e372b906527d89d06fa8f}
...
void {\bf Print} () const \label{a00076_a74fa173d33eb724be83a2ede6042dce3}

\begin{DoxyCompactList}\small\item\em Print to screen/console the charcteristics of the radiation. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bfseries Get\-Linear\-Polar\-Rate} () const \label{a00076_a103b3216086ff11bfe3465e2d057fbda}

\item 
void {\bfseries Set\-Linear\-Polar\-Rate} (const R\-E\-A\-L f)\label{a00076_a9602288c888944773e93fa67f8542d95}

\end{DoxyCompactItemize}
\subsubsection*{Private Member Functions}
\begin{DoxyCompactItemize}
\item 
void {\bfseries Init\-Options} ()\label{a00076_a4663c4bfeb1bb617f77896179fb0a2d2}

\end{DoxyCompactItemize}
\subsubsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
{\bf Ref\-Obj\-Opt} {\bf m\-Radiation\-Type}\label{a00076_a3b736f32b507d8e0f4ebd8b46e50659b}

\begin{DoxyCompactList}\small\item\em Neutron ? X-\/\-Ray ? (Electron\-: unimplemented) \end{DoxyCompactList}\item 
{\bf Ref\-Obj\-Opt} {\bf m\-Wavelength\-Type}\label{a00076_a9ef30865d93e28dbba31fee53c4c39aa}

\begin{DoxyCompactList}\small\item\em monochromatic ? Alpha1 \& Alpha2 ? Multi-\/\-Wavelength ? \end{DoxyCompactList}\item 
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Wavelength}\label{a00076_a1c786f2e4a6035954fc76cb7cb7ad736}
...
R\-E\-A\-L {\bf m\-X\-Ray\-Tube\-Delta\-Lambda}\label{a00076_a66546a093f76ef3b9822be44e98ca17f}

\begin{DoxyCompactList}\small\item\em Absolute difference between alpha1 and alpha2, in angstroems. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf m\-X\-Ray\-Tube\-Alpha2\-Alpha1\-Ratio}\label{a00076_a72fd03ef0f28986f3ea66fd96d040688}

\begin{DoxyCompactList}\small\item\em Ratio alpha2/alpha1 (should be 0.\-5) \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Wavelength}\label{a00076_af492e24a913e63781a53946feecb6ffc}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Radiation}\label{a00076_a255532a6369c7265df67aabba103153f}

\item 
R\-E\-A\-L {\bf m\-Linear\-Polar\-Rate}\label{a00076_a0e8a10c625ae1bd2733e830c2ca7d606}
...
X-\/\-Rays and Neutrons are available. Electrons are not available yet in \doxyref{Scattering\-Data}{p.}{a00096} classes.
...
)}\label{a00076_ace67fea27bc640ac4820fc1ba73114d5}
...
\end{DoxyParamCaption}
)}\label{a00076_a0302f8a0f706db01d0ada609c2e427d4}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00076_a56558c41ec3bd350a2904f5e469fb68a}
...
{}
\end{DoxyParamCaption}
) const}\label{a00076_a8dc3440d994fe1af5713dd254c56302c}
...
\item[{const R\-E\-A\-L}]{alpha2\-Alpha2ratio = {\ttfamily 0.5}}
\end{DoxyParamCaption}
)}\label{a00076_a61393e596990f9fdac7dfc6d8acd91ac}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00076_a67d99d4fbfd583a3d257c9fce177445d}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00076_a6d458f97232013cc128123e94b6e9937}
...
\paragraph[{m\-X\-Ray\-Tube\-Name}]{\setlength{\rightskip}{0pt plus 5cm}string Obj\-Cryst\-::\-Radiation\-::m\-X\-Ray\-Tube\-Name\hspace{0.3cm}{\ttfamily [private]}}\label{a00076_a3af206eb2068d56ec54d57262c619346}
