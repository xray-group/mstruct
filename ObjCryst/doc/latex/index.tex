...
\subsection{News}\label{a00013_news}
...
The new version includes major changes for several classes (Scattering\-Power, Powder\-Pattern), and includes the graphical classes associated with all objects using {\tt wx\-Windows}, and saving all objects using a new, more expandable {\tt X\-M\-L}-\/based format.\subsection{Introduction}\label{a00013_intro}
