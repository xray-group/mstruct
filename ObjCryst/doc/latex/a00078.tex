...
\label{a00078}\index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}}
...
\item 
{\bf Refinable\-Obj} ()\label{a00078_a081d2bfc2065c2adaa2bfdf292900235}
...
virtual {\bf $\sim$\-Refinable\-Obj} ()\label{a00078_a5cd8d41a828153e2585077a9fbd334ce}
...
virtual const string \& {\bf Get\-Name} () const \label{a00078_a61f51d3364e13a542e8c32df454c88aa}

\begin{DoxyCompactList}\small\item\em Name of the object. \end{DoxyCompactList}\item 
virtual void {\bf Set\-Name} (const string \&name)\label{a00078_a464caf574804fc21bd896f823131a1d7}
...
void {\bf Fix\-All\-Par} ()\label{a00078_ac1a65da1f7563472badaf699002b8b8b}

\begin{DoxyCompactList}\small\item\em Fix All parameters. \end{DoxyCompactList}\item 
void {\bf Un\-Fix\-All\-Par} ()\label{a00078_ab75dcf763d7f96063dcb4d85e6e78007}

\begin{DoxyCompactList}\small\item\em Un\-Fix All parameters. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Fixed} (const long par\-Index, const bool fix)\label{a00078_ad6284ca6b92364e1ebd02bbef81d7e7e}

\begin{DoxyCompactList}\small\item\em Fix/un-\/fix one parameter from its \#. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Fixed} (const string \&par\-Name, const bool fix)\label{a00078_a8dc4cb100f839e12a9e0ae01facc5c9c}

\begin{DoxyCompactList}\small\item\em Fix/un-\/fix one parameter from its name. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Fixed} (const {\bf Ref\-Par\-Type} $\ast$type, const bool fix)\label{a00078_acc7f25893d4dc4cec08fd04a84aa008d}

\begin{DoxyCompactList}\small\item\em Fix/un-\/fix one family of parameters. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Used} (const string \&par\-Name, const bool use)\label{a00078_a1d0737a4ecb7cb1339f3138cd792ba7c}

\begin{DoxyCompactList}\small\item\em Set whether a parameter is used. \end{DoxyCompactList}\item 
void {\bf Set\-Par\-Is\-Used} (const {\bf Ref\-Par\-Type} $\ast$type, const bool use)\label{a00078_a40eba4b59117dd18831286e05b5b982c}
...
long {\bf Get\-Nb\-Par\-Not\-Fixed} () const \label{a00078_a6ead9da8785dbaa3dc4fb5f93cb455a3}

\begin{DoxyCompactList}\small\item\em Total number of non-\/fixed parameters. Is initialized by \doxyref{Prepare\-For\-Refinement()}{p.}{a00078_a0e9b816ad753f633ef6d9650ec6b4ca6} \end{DoxyCompactList}\item 
{\bf Refinable\-Par} \& {\bf Get\-Par} (const long i)\label{a00078_ae5c543d3b0fb010afa37b5f12620405b}

\begin{DoxyCompactList}\small\item\em Access all parameters in the order they were inputted. \end{DoxyCompactList}\item 
const {\bf Refinable\-Par} \& {\bf Get\-Par} (const long i) const \label{a00078_a5686cc39b27bc719be33aad0700438a1}

\begin{DoxyCompactList}\small\item\em Access all parameters in the order they were inputted. \end{DoxyCompactList}\item 
{\bf Refinable\-Par} \& {\bf Get\-Par} (const string \&name)\label{a00078_aea1c3b652c3f1eb5444bd47456e04392}

\begin{DoxyCompactList}\small\item\em Access all parameters from their name. \end{DoxyCompactList}\item 
const {\bf Refinable\-Par} \& {\bf Get\-Par} (const string \&name) const \label{a00078_a519b443c48cc463ed6b0682a6f557074}

\begin{DoxyCompactList}\small\item\em Access all parameters from their name. \end{DoxyCompactList}\item 
{\bf Refinable\-Par} \& {\bf Get\-Par} (const R\-E\-A\-L $\ast$)\label{a00078_a07ea375ae64f69559e0b595e8c111087}

\begin{DoxyCompactList}\small\item\em Access parameter from its adress. \end{DoxyCompactList}\item 
const {\bf Refinable\-Par} \& {\bf Get\-Par} (const R\-E\-A\-L $\ast$) const \label{a00078_a82b9eeedc157f76f17e9f9461c3a11d7}

\begin{DoxyCompactList}\small\item\em Access parameter from its adress. \end{DoxyCompactList}\item 
long {\bf Get\-Par\-Index} (const string \&name, const bool nothrow=false) const \label{a00078_ac226ae69247c59e1d22b5be5010534c9}
...
long {\bf Get\-Par\-Index} (const R\-E\-A\-L $\ast$, const bool nothrow=false) const \label{a00078_a86afd7f55aafa42dd0a65a04c3eaf192}
...
\begin{DoxyCompactList}\small\item\em Add all the parameters in another \doxyref{Refinable\-Obj}{p.}{a00078}. \end{DoxyCompactList}\item 
...
virtual void {\bfseries Print} () const \label{a00078_a6033a7d7892806d9157daad9c4aea8c3}
...
void {\bf Clear\-Param\-Set} (const unsigned long id) const \label{a00078_ae9a2401becfcd7dda785c0931d3f31f3}
...
void {\bf Set\-Limits\-Absolute} (const string \&par\-Name, const R\-E\-A\-L min, const R\-E\-A\-L max)\label{a00078_a2f24a7b834f5588e32aac9c6e33a1020}
...
void {\bf Set\-Limits\-Absolute} (const {\bf Ref\-Par\-Type} $\ast$type, const R\-E\-A\-L min, const R\-E\-A\-L max)\label{a00078_a371f137ad14a77ee3b545520d05fe4d6}
...
void {\bf Set\-Global\-Optim\-Step} (const {\bf Ref\-Par\-Type} $\ast$type, const R\-E\-A\-L step)\label{a00078_ae4f0b5b0038ff3b49dcdc8adbf98bc58}
...
{\bf Obj\-Registry}$<$ {\bf Refinable\-Obj} $>$ \& {\bf Get\-Sub\-Obj\-Registry} ()\label{a00078_a30e81164b0176ca00e90d994ca0a0827}

\begin{DoxyCompactList}\small\item\em Access to the registry of \doxyref{Refinable\-Obj}{p.}{a00078} used by this object. \end{DoxyCompactList}\item 
const {\bf Obj\-Registry}$<$ {\bf Refinable\-Obj} $>$ \& {\bf Get\-Sub\-Obj\-Registry} () const \label{a00078_a23999d5fb06661cddc9bfa294c48624e}
...
virtual void {\bf De\-Register\-Client} ({\bf Refinable\-Obj} \&) const \label{a00078_ae37091ca0b7091eaf87bf630433ad91d}
...
$<$ {\bf Refinable\-Obj} $>$ \& {\bf Get\-Client\-Registry} () const \label{a00078_abb63797f2ffc7e8317f66ce9749f105f}

\begin{DoxyCompactList}\small\item\em Get the list of clients. \end{DoxyCompactList}\item 
virtual {\bf Obj\-Registry}\\*
$<$ {\bf Refinable\-Obj} $>$ \& {\bf Get\-Client\-Registry} ()\label{a00078_aaf7fdd5c8d015285639fe24138e31b6b}

\begin{DoxyCompactList}\small\item\em Get the list of clients. \end{DoxyCompactList}\item 
bool {\bf Is\-Being\-Refined} () const \label{a00078_addbd91121eaf715f67080d95cfdc857c}
...
\begin{DoxyCompactList}\small\item\em Raise a flag, to be sure not to make a random change more than once in each \doxyref{Refinable\-Obj}{p.}{a00078}. \end{DoxyCompactList}\item 
...
virtual unsigned int {\bf Get\-Nb\-L\-S\-Q\-Function} () const \label{a00078_af435b8a23739f154222ba619f67cfc92}

\begin{DoxyCompactList}\small\item\em Number of L\-S\-Q functions. \end{DoxyCompactList}\item 
virtual const Cryst\-Vector\-\_\-\-R\-E\-A\-L \& {\bf Get\-L\-S\-Q\-Calc} (const unsigned int) const \label{a00078_a99e8e0a4d761829f940c0ed3d29fec89}

\begin{DoxyCompactList}\small\item\em Get the current calculated value for the L\-S\-Q function. \end{DoxyCompactList}\item 
virtual const Cryst\-Vector\-\_\-\-R\-E\-A\-L \& {\bf Get\-L\-S\-Q\-Obs} (const unsigned int) const \label{a00078_a60ecf8524c697c0385c3810b825459f2}

\begin{DoxyCompactList}\small\item\em Get the observed values for the L\-S\-Q function. \end{DoxyCompactList}\item 
virtual const Cryst\-Vector\-\_\-\-R\-E\-A\-L \& {\bf Get\-L\-S\-Q\-Weight} (const unsigned int) const \label{a00078_a798d3ab37d696395897a0a416f0757c0}
...
unsigned int {\bf Get\-Nb\-Option} () const \label{a00078_a389c9d9ed7e8c700abfa4dfb72a32792}

\begin{DoxyCompactList}\small\item\em Number of Options for this object. \end{DoxyCompactList}\item 
{\bf Ref\-Obj\-Opt} \& {\bf Get\-Option} (const unsigned int i)\label{a00078_a2dcb69d78e55dc75a7377e5a772536de}

\begin{DoxyCompactList}\small\item\em Access to the options. \end{DoxyCompactList}\item 
const {\bf Ref\-Obj\-Opt} \& {\bf Get\-Option} (const unsigned int i) const \label{a00078_a77b66fd9c4e752e9b58ecd9e5ec2a218}
...
\begin{DoxyCompactList}\small\item\em What was the last time a \doxyref{Refinable\-Par}{p.}{a00080} was added/removed ? \end{DoxyCompactList}\item 
...
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Master} () const \label{a00078_a5910fb213a6b51da18d5f65badceb029}
...
\begin{DoxyCompactItemize}
\item 
long {\bf Find\-Par} (const string \&name) const \label{a00078_a6c1fd4ec11915278a6a9db9bf3aa1374}

\begin{DoxyCompactList}\small\item\em Find a refinable parameter with a given name. \end{DoxyCompactList}\item 
long {\bf Find\-Par} (const R\-E\-A\-L $\ast$) const \label{a00078_a96acb0979c364332bc5365a73b58a246}
...
$<$ Cryst\-Vector\-\_\-\-R\-E\-A\-L, string $>$\\*
 $>$\-::iterator {\bf Find\-Param\-Set} (unsigned long id) const \label{a00078_a5db8d488c4782f2e143fbb6ec96e0b32}
...
\begin{DoxyCompactItemize}
\item 
string {\bf m\-Name}\label{a00078_ad8ddc8c4b3daae8649986d7febc5fca4}
...
vector$<$ {\bf Refinable\-Par} $\ast$ $>$ {\bf mvp\-Ref\-Par}\label{a00078_ae05556c30ef2d6818c22750c89690fc9}
...
long {\bf m\-Nb\-Ref\-Par\-Not\-Fixed}\label{a00078_a8cffff9a5b5d2a76bd9e29cce5f4700e}

\begin{DoxyCompactList}\small\item\em Total of not-\/fixed parameters. \end{DoxyCompactList}\item 
Cryst\-Vector\-\_\-long {\bf m\-Refpar\-Not\-Fixed\-Index}\label{a00078_a359f6599fdaa11ea01afd91289265bac}
...
{\bf Obj\-Registry}$<$ {\bf Refinable\-Obj} $>$ {\bf m\-Sub\-Obj\-Registry}\label{a00078_a101ff2559ab840729c8cbc7b2469afd6}
...
\begin{DoxyCompactList}\small\item\em If true (the default), then all \doxyref{Refinable\-Par}{p.}{a00080} will be deleted when the the object is deleted. \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Ref\-Par\-List\-Clock}\label{a00078_a867562fcd8c5afd0fd178c98729e1f35}
...
)}\label{a00078_aa0eaf0982686476cbec02a8afeebc92d}
...
\end{DoxyParamCaption}
)}\label{a00078_a5f77dcf037cc8d2ea1fd84bfda6ddbc0}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_a8bd8353b34fc4088a987be0eaf01e5f6}
...
\end{DoxyParamCaption}
)}\label{a00078_a0c0050a3d3141ca34eb8f4b559ad2f8d}
...
\end{DoxyParamCaption}
)}\label{a00078_a4a792c84f7d35e71b3e89aae5a87bffa}
...
\end{DoxyParamCaption}
)}\label{a00078_a6a28259e473fadd53fbc9b9bf7930813}


Add all the parameters in another \doxyref{Refinable\-Obj}{p.}{a00078}. 

Parameters are  copied, so they should be allocated in the heap.

\begin{DoxyWarning}{Warning}
If a copy of another \doxyref{Refinable\-Obj}{p.}{a00078} parameter list is made, such as in the \doxyref{Optimization\-Obj}{p.}{a00062} class, make sure that upon deletion of this object the parameters will not be destroyed. To do this use Refinable\-Obj\-::\-Set\-Delete\-Ref\-Par\-In\-Destructor(false).
\end{DoxyWarning}
...
\end{DoxyParamCaption}
)}\label{a00078_a0eec1ccf5ba9769e5c6a82a85ecf451d}


Add a new restraint. 

This returns an iterator pointing to the next \doxyref{Restraint}{p.}{a00088} in the vector. \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Add\-Sub\-Ref\-Obj@{Add\-Sub\-Ref\-Obj}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_ae4740b33ea934e4ab9b9bce9ebbfa806}
...
{}
\end{DoxyParamCaption}
)}\label{a00078_a47fc5a85493671a3590ed7e3971b18fe}


Raise a flag, to be sure not to make a random change more than once in each \doxyref{Refinable\-Obj}{p.}{a00078}. 
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_ababd8f2916e41a20d2c1b21f6ffefe96}
...
\doxyref{End\-Optimization()}{p.}{a00078_ab0035f6164cb24ace67b51b11993a851} must be called at the end of the optimization, the same number of time \doxyref{Begin\-Optimization()}{p.}{a00078_ababd8f2916e41a20d2c1b21f6ffefe96} was called !
\end{DoxyNote}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_a8e29b6186253d686c4f078906592df7b}, {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a5fbdadb37966f382a6e33150285819dc}, {\bf Obj\-Cryst\-::\-Scattering\-Data} \doxyref{}{p.}{a00096_a6b0f18996edafa21a03bf9550dcf8981}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a44d10a7c3404153fe4513c8944629c45}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_afe25ea6d287d6dd9cd0a03aed3798525}, {\bf Obj\-Cryst\-::\-Cell\-Explorer} \doxyref{}{p.}{a00021_ae75ee0eb6652d5d43404b7205ec3cb94}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_ac9a022b49d583e8ae81e4d96e50cc9d8}, and {\bf Obj\-Cryst\-::\-Texture\-March\-Dollase} \doxyref{}{p.}{a00111_a73f6148d035bbdeb98b0115d76fe48a8}.
...
\end{DoxyParamCaption}
) const}\label{a00078_abd5b0aa78ff6ec95838e78e2d3685b56}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_ab0035f6164cb24ace67b51b11993a851}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_aec0a3ba0d08fdfed38cc757efb635ffb}, {\bf Obj\-Cryst\-::\-Scattering\-Data} \doxyref{}{p.}{a00096_a782e0caf5c6f2941ca64d17293b1e8b4}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a11f7690878a07983de3abb839b087798}, and {\bf Obj\-Cryst\-::\-Z\-Scatterer} \doxyref{}{p.}{a00163_a5742d1fa13b1300c92359ef1250753c3}.
...
{}
\end{DoxyParamCaption}
)}\label{a00078_ac269ad4ad4ca8b4e9f13f5466475d959}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a62968d90a7a3080738b363934616c019}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a7f0f1ae6670032f5afc9ccf65d45f8c4}, {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_a20dadada4d5b428c5122d4c75fb49164}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a87fcc8fe4871d1b9b6ec08af5f353657}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a74b02e35219c6bc18521e66719778881}, {\bf Obj\-Cryst\-::\-Cell\-Explorer} \doxyref{}{p.}{a00021_a67ec6642b2a93030878764091178a0fb}, {\bf Obj\-Cryst\-::\-Z\-Scatterer} \doxyref{}{p.}{a00163_a610a62c221ed289e1ce4d68adac921ee}, {\bf Obj\-Cryst\-::\-Radiation} \doxyref{}{p.}{a00076_a56558c41ec3bd350a2904f5e469fb68a}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_afae084513270b7adf50954bec4037380}, {\bf Obj\-Cryst\-::\-Reflection\-Profile\-Double\-Exponential\-Pseudo\-Voigt} \doxyref{}{p.}{a00082_a5e921c0682e78188e422c006e34df8a0}, {\bf Obj\-Cryst\-::\-Texture\-March\-Dollase} \doxyref{}{p.}{a00111_a2b1002c1ed071f53b2a6f1b953527cc2}, {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a374fc1bb2887ab1f61d456326d97c05f}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_ad1f69a5fb8981a2cf0eeb6245728af6d}, {\bf Obj\-Cryst\-::\-Scattering\-Power} \doxyref{}{p.}{a00097_ac31cc4135011046f93d49f4173aee3ee}, {\bf Obj\-Cryst\-::\-Reflection\-Profile\-Pseudo\-Voigt} \doxyref{}{p.}{a00083_a55628cdadc249b7973f2a6471d478e76}, {\bf Obj\-Cryst\-::\-Unit\-Cell} \doxyref{}{p.}{a00117_ac3b3c2e007083bf6f329eb11a6b610d1}, {\bf Obj\-Cryst\-::\-Atom} \doxyref{}{p.}{a00015_a9f0d1cb7c3b1db1baf84076e5da0ca0e}, {\bf Obj\-Cryst\-::\-Diffraction\-Data\-Single\-Crystal} \doxyref{}{p.}{a00033_a05b1f448a143ad61036f001d09a3509f}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a57e85d29926fe93da66041a43583e893}, {\bf Obj\-Cryst\-::\-P\-D\-F} \doxyref{}{p.}{a00063_a809ab3f4cc8bdd268bd815baedccdc20}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Component} \doxyref{}{p.}{a00072_a5e797476d8d76ef797e1e8b51db9e8fb}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background\-Bayesian\-Minimiser} \doxyref{}{p.}{a00071_a7f39f799fafc12a3bdb937b5cc9545ad}.
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_ad59c8ad2b0d7ee59fa3f399a54f05e54}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_ad3b643041cc61a3d39765bd7c268d6bc}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a7c6a94f74a6010abdb9ba4d5a8653d3f}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_afcef6e251265ddf23657fe10b0cd4912}, {\bf Obj\-Cryst\-::\-Z\-Scatterer} \doxyref{}{p.}{a00163_ae8143bbd71decab10138ddadf0e8b220}, {\bf Obj\-Cryst\-::\-Scattering\-Power} \doxyref{}{p.}{a00097_aae98160e01ecb2098cf4777126860aa5}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_ae34c8b65496994cce5b6b73748d3a2b9}, and {\bf Obj\-Cryst\-::\-Atom} \doxyref{}{p.}{a00015_a01645142310cf68d21b50ec514a0af77}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a9a9a5ea2b997cd36b44ed35c2bab3245}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_a40363370a5a3e82d445fc3f1d653fd63}, {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a1c0e8ad2410035c07c4be88315554f3f}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_a6f10c5a30864b9699b313f90b646138f}, {\bf Obj\-Cryst\-::\-Diffraction\-Data\-Single\-Crystal} \doxyref{}{p.}{a00033_ad42c5159763eb136fadfb653067d1a7b}, {\bf Obj\-Cryst\-::\-Z\-Move\-Minimizer} \doxyref{}{p.}{a00161_a1a0bd982430b7f38d54ed798edd6ac18}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background\-Bayesian\-Minimiser} \doxyref{}{p.}{a00071_a515e6c16b8900dd4360bcae023ebbd38}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a24bfb12849c7733a7034928fbb0b14a8}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_adef00ca72bec0e4553bbfba0852e1ba1}, and {\bf Obj\-Cryst\-::\-Cell\-Explorer} \doxyref{}{p.}{a00021_a6e4e1e3300bbf3e5f23900fccb135da3}.
...
{}
\end{DoxyParamCaption}
) const}\label{a00078_a945800fc9c72fb9a538e384a7831b37f}


Total number of refinable parameter in the object. 

Note that some may be actually fixed or even not used !! For refinement use \doxyref{Prepare\-For\-Refinement()}{p.}{a00078_a0e9b816ad753f633ef6d9650ec6b4ca6}, Nb\-Ref\-Par\-Not\-Fixed(), and Par\-Not\-Fixed(i) \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Get\-Param\-Set@{Get\-Param\-Set}}
...
\end{DoxyParamCaption}
) const}\label{a00078_aa5ebd29814d5ed1a18a669ea0f3417f3}
...
\item[{const unsigned long}]{set\-Id}
\end{DoxyParamCaption}
)}\label{a00078_a33290cd0d3d90620cb7465dacb675085}
...
\end{DoxyParamCaption}
) const}\label{a00078_ab17775f3f007ae6edd2de6fd2433c6ce}
...
\item[{const unsigned long}]{set\-Id}
\end{DoxyParamCaption}
) const}\label{a00078_a1426f90c9b580a4854917ab7db876c3e}
...
\item[{const long}]{i}
\end{DoxyParamCaption}
)}\label{a00078_ae06ade6e11e2de4d041d07612a7d802c}


Access all parameters in the order they were inputted, skipping fixed parameters. 

Must call \doxyref{Prepare\-For\-Refinement()}{p.}{a00078_a0e9b816ad753f633ef6d9650ec6b4ca6} before ! \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Get\-Par\-Not\-Fixed@{Get\-Par\-Not\-Fixed}}
\index{Get\-Par\-Not\-Fixed@{Get\-Par\-Not\-Fixed}!ObjCryst::RefinableObj@{Obj\-Cryst\-::\-Refinable\-Obj}}
...
\item[{const long}]{i}
\end{DoxyParamCaption}
) const}\label{a00078_a91112351e072c2448c4af8be3ad2da12}


Access all parameters in the order they were inputed, skipping fixed parameters. 

Must call \doxyref{Prepare\-For\-Refinement()}{p.}{a00078_a0e9b816ad753f633ef6d9650ec6b4ca6} before ! \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Get\-Ref\-Par\-List\-Clock@{Get\-Ref\-Par\-List\-Clock}}
...
{}
\end{DoxyParamCaption}
) const}\label{a00078_a52422a72840cdb07ac5274eced2d2152}


What was the last time a \doxyref{Refinable\-Par}{p.}{a00080} was added/removed ? 
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a92288a2ec22c405bbb9985bdc1a0b633}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a18375c8525ae38c481ba77e9cf9d67c1}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_a35119a32e043f1b9e003cfe1ed18a1b1}, {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a11e623f6482b468f6dd05fc0ab2bbb24}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_ab6a8a2cc28f3b1cde012754a19c279de}, {\bf Obj\-Cryst\-::\-Z\-Scatterer} \doxyref{}{p.}{a00163_a6df5359190e4cf5dc45a5e72c9a5a9a0}, {\bf Obj\-Cryst\-::\-Diffraction\-Data\-Single\-Crystal} \doxyref{}{p.}{a00033_a9f19efd0a77a471666ddd5b4be421ffa}, and {\bf Obj\-Cryst\-::\-Texture\-March\-Dollase} \doxyref{}{p.}{a00111_a43d8d96c3f14d9d01145dfbefb759e6a}.
...
\item[{const {\bf Refinable\-Obj} \&}]{old}
\end{DoxyParamCaption}
)}\label{a00078_ab9b15adff1092f15e8f06cfeecc314f8}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00078_a48d11671e7f8699f7bc24077585c5e0f}
Prepare everything (if necessary) for an optimization/calculation. 

Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_ae03f4d2f08e749e4f494eb78050dbffe}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_ae19852383674ae3ab673748a30a8432a}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_aac7d53c229cd59c2c9d4c5de539a60e1}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Component} \doxyref{}{p.}{a00072_a6a99877f0f9dec09fd5f596a7ddeb6f6}.
...
{}
\end{DoxyParamCaption}
) const}\label{a00078_a0e9b816ad753f633ef6d9650ec6b4ca6}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a01b02e566db9aebfd0f9ed2647441f40}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_aaa76da93619174b17db73de9d2374ac7}.
...
\item[{{\bf Refinable\-Obj} \&}]{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a8afc65925b0e4d1894d72c457ad38bc9}
...
\end{DoxyParamCaption}
)}\label{a00078_a33a10888dfa13b40a5989d6b9af52174}
...
\end{DoxyParamCaption}
)}\label{a00078_a0e738f16d06bed8a50985a97deb48e7d}


Remove a restraint from the list of known restraints. 

This does not delete the \doxyref{Restraint}{p.}{a00088} object. \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Remove\-Sub\-Ref\-Obj@{Remove\-Sub\-Ref\-Obj}}
...
\item[{{\bf Refinable\-Obj} \&}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_af533cb95da45c5ce875c9f5ec8cf9c1e}
...
{}
\end{DoxyParamCaption}
)}\label{a00078_a3b6228c6fbd154441d935af2d511fe82}


Re-\/init the list of refinable parameters, removing all parameters. 

This does {\itshape not} delete the \doxyref{Refinable\-Par}{p.}{a00080} if \doxyref{Refinable\-Obj\-::m\-Delete\-Ref\-Par\-In\-Destructor}{p.}{a00078_a8e3295302c9a1f9ea29f1749132e561b} is false \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Restore\-Param\-Set@{Restore\-Param\-Set}}
...
\end{DoxyParamCaption}
)}\label{a00078_a057437fe6759b589906d8a16f9732e22}
...
\item[{const unsigned long}]{id}
\end{DoxyParamCaption}
) const}\label{a00078_afdcabf808440aa0d566e56f145de235d}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a565c41c23c04f5945512374ae671e2e3}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Scattering\-Data} \doxyref{}{p.}{a00096_a109ed8c2e8dc676e77aa80feafa91071}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a0e7b4a6f4b3a7b783ebed15230a1c45f}.
...
\item[{const bool}]{b}
\end{DoxyParamCaption}
)}\label{a00078_a33f94e9c9c0717ea77c8b9427e9e137e}


Set this object not to delete its list of parameters when destroyed. 

This is used for the \doxyref{Refinable\-Obj}{p.}{a00078} in algorithms objects (\doxyref{Optimization\-Obj}{p.}{a00062}), which only hold copies of parameters from the refined objects. \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!Set\-Limits\-Proportional@{Set\-Limits\-Proportional}}
...
\end{DoxyParamCaption}
)}\label{a00078_adc6b05a95d524d600910a47861190e84}
...
\item[{const R\-E\-A\-L}]{max}
\end{DoxyParamCaption}
)}\label{a00078_a75741a3e7f7f1740243901b60f406e93}
...
\item[{const R\-E\-A\-L}]{max}
\end{DoxyParamCaption}
)}\label{a00078_acacf469614253239fdeebb21e50f0c1c}
...
\item[{const R\-E\-A\-L}]{max}
\end{DoxyParamCaption}
)}\label{a00078_ae8d497fc43ac3f166a21781a62dfa25d}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a3cb4cc924d39576618184eccd4321cf6}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a91e2f80f1e4526fbb6cd99f5b229db9e}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_af1a8228087bafd3c3ae0830b3d94df2a}, and {\bf Obj\-Cryst\-::\-Texture\-March\-Dollase} \doxyref{}{p.}{a00111_a972d51af36bfd317f794c87841c58b5a}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_ab74e2cead734fe1e652c5add46c5e116}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_af1ae2c4f9febbe16019987f807271b58}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_ac13a4045c3f187879443c8615c38d623}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_ae80f37cee10c08e6acb02300fe30c894}, {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a701f78d93d495d1102d0bd26700c4a3d}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a9f2e4623c47ffc8d641ea48ef5d6cefa}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_af350a4a95ddac5f15812bf35015f83fb}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_accc77bfc6df977685c01a43d150a8ba7}, {\bf Obj\-Cryst\-::\-Z\-Scatterer} \doxyref{}{p.}{a00163_afb23d2cf7f8fd74f790d7dd0835256b1}, {\bf Obj\-Cryst\-::\-Radiation} \doxyref{}{p.}{a00076_a67d99d4fbfd583a3d257c9fce177445d}, {\bf Obj\-Cryst\-::\-Diffraction\-Data\-Single\-Crystal} \doxyref{}{p.}{a00033_a3b1edc7d3c612fa20cb658ef1d084c00}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a7747e4a20056c4756943319bc8ffba8d}, {\bf Obj\-Cryst\-::\-Reflection\-Profile\-Double\-Exponential\-Pseudo\-Voigt} \doxyref{}{p.}{a00082_a4965f2a8994475187423a7afd6943031}, {\bf Obj\-Cryst\-::\-Texture\-March\-Dollase} \doxyref{}{p.}{a00111_a26ae81ce2e09c173d200c9a61cb67161}, {\bf Obj\-Cryst\-::\-Atom} \doxyref{}{p.}{a00015_a08fe773b05dd0dc748b8008636b56187}, {\bf Obj\-Cryst\-::\-Reflection\-Profile\-Pseudo\-Voigt} \doxyref{}{p.}{a00083_a8c63700610f511503eae297c8161f311}, {\bf Obj\-Cryst\-::\-Reflection\-Profile} \doxyref{}{p.}{a00081_a7ad38593ddb4601632beb0a6bcae50f3}, and {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_aaaf687a105e65c6522521a0f01a98acf}.
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00078_a7b9b6ed0f8dcf753d398c35e073de973}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern} \doxyref{}{p.}{a00069_a85e8803b7680a6d3b5463990fee76c6f}, {\bf Obj\-Cryst\-::\-Molecule} \doxyref{}{p.}{a00054_a47762abe37f3e8f7378b7210916e71ea}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a03090c251445ac6a5b08134032980310}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_af4a2a4dbdbc9eb85274835a4b3d10be9}, {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_a037f8ea8c5dceece1044ce73d542a0e4}, {\bf Obj\-Cryst\-::\-Z\-Scatterer} \doxyref{}{p.}{a00163_a406d107bfd110c5c3de61208348d4ad0}, {\bf Obj\-Cryst\-::\-Radiation} \doxyref{}{p.}{a00076_a6d458f97232013cc128123e94b6e9937}, {\bf Obj\-Cryst\-::\-Diffraction\-Data\-Single\-Crystal} \doxyref{}{p.}{a00033_a59dadf9f6dedc3a84e858ee96268526e}, {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a41f59111f35f92d0c3b99942606b234e}, {\bf Obj\-Cryst\-::\-Reflection\-Profile\-Double\-Exponential\-Pseudo\-Voigt} \doxyref{}{p.}{a00082_a6ec9818370703767da5362960c5b310a}, {\bf Obj\-Cryst\-::\-Texture\-March\-Dollase} \doxyref{}{p.}{a00111_a09d994c3344a276ba65563fb9f1b45ca}, {\bf Obj\-Cryst\-::\-Atom} \doxyref{}{p.}{a00015_a83bd4047affa8c4de3126465595b77cb}, {\bf Obj\-Cryst\-::\-Reflection\-Profile\-Pseudo\-Voigt} \doxyref{}{p.}{a00083_ac0438d3a1827accbdf2375e7355f18e5}, {\bf Obj\-Cryst\-::\-Reflection\-Profile} \doxyref{}{p.}{a00081_a60e429bb999a8b39f09ef14cdaf5ad0c}, and {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a050e8e8b21857ec0593bbb41fd123e39}.
...
\paragraph[{m\-Client\-Obj\-Registry}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Obj\-Registry}$<${\bf Refinable\-Obj}$>$ Obj\-Cryst\-::\-Refinable\-Obj\-::m\-Client\-Obj\-Registry\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00078_abe0324d0b4bbd15ee9134412b98f55c3}
...
\paragraph[{m\-Clock\-Master}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Refinable\-Obj\-Clock} Obj\-Cryst\-::\-Refinable\-Obj\-::m\-Clock\-Master\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_acbb5e80371ef0c72ef1bd8559226ae22}
...
\paragraph[{m\-Delete\-Ref\-Par\-In\-Destructor}]{\setlength{\rightskip}{0pt plus 5cm}bool Obj\-Cryst\-::\-Refinable\-Obj\-::m\-Delete\-Ref\-Par\-In\-Destructor\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_a8e3295302c9a1f9ea29f1749132e561b}


If true (the default), then all \doxyref{Refinable\-Par}{p.}{a00080} will be deleted when the the object is deleted. 

The opposite option (false) should only be used in \doxyref{Refinable\-Obj}{p.}{a00078} holding 'copies' of other objects, such as in algorithms. \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!m\-L\-S\-Q\-Deriv@{m\-L\-S\-Q\-Deriv}}
\index{m\-L\-S\-Q\-Deriv@{m\-L\-S\-Q\-Deriv}!ObjCryst::RefinableObj@{Obj\-Cryst\-::\-Refinable\-Obj}}
\paragraph[{m\-L\-S\-Q\-Deriv}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Vector\-\_\-\-R\-E\-A\-L Obj\-Cryst\-::\-Refinable\-Obj\-::m\-L\-S\-Q\-Deriv\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00078_a20a9cbc22a6b81f95dc66ebd0ed1668d}
...
\paragraph[{m\-Optimization\-Depth}]{\setlength{\rightskip}{0pt plus 5cm}int Obj\-Cryst\-::\-Refinable\-Obj\-::m\-Optimization\-Depth\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_a920ae46a7d90f940866d35b7548d77a8}
...
\paragraph[{m\-Option\-Registry}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Obj\-Registry}$<${\bf Ref\-Obj\-Opt}$>$ Obj\-Cryst\-::\-Refinable\-Obj\-::m\-Option\-Registry\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_a85a478e7564d71102aedf7c3e81f56d0}
...
\paragraph[{m\-Random\-Move\-Is\-Done}]{\setlength{\rightskip}{0pt plus 5cm}bool Obj\-Cryst\-::\-Refinable\-Obj\-::m\-Random\-Move\-Is\-Done\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_aab4b8fa7fc23598d79351ebd500beb3e}
This true is false if \doxyref{Refinable\-Obj\-::\-Global\-Opt\-Random\-Move()}{p.}{a00078_a18375c8525ae38c481ba77e9cf9d67c1} has been called since \doxyref{Refinable\-Obj\-::\-Begin\-Global\-Opt\-Random\-Move()}{p.}{a00078_a47fc5a85493671a3590ed7e3971b18fe} was called. \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!mvp\-Restraint@{mvp\-Restraint}}
\index{mvp\-Restraint@{mvp\-Restraint}!ObjCryst::RefinableObj@{Obj\-Cryst\-::\-Refinable\-Obj}}
\paragraph[{mvp\-Restraint}]{\setlength{\rightskip}{0pt plus 5cm}vector$<${\bf Restraint}$\ast$$>$ Obj\-Cryst\-::\-Refinable\-Obj\-::mvp\-Restraint\hspace{0.3cm}{\ttfamily [protected]}}\label{a00078_ad3b06da1eb64191be95934c097829efc}


Vector of pointers to the restraints for this object. 

This excludes all \doxyref{Refinable\-Par}{p.}{a00080} declared in Refinable\-Obj\-::mp\-Ref\-Par, which also are \doxyref{Restraint}{p.}{a00088}. \index{Obj\-Cryst\-::\-Refinable\-Obj@{Obj\-Cryst\-::\-Refinable\-Obj}!mvp\-Saved\-Values\-Set@{mvp\-Saved\-Values\-Set}}
\index{mvp\-Saved\-Values\-Set@{mvp\-Saved\-Values\-Set}!ObjCryst::RefinableObj@{Obj\-Cryst\-::\-Refinable\-Obj}}
\paragraph[{mvp\-Saved\-Values\-Set}]{\setlength{\rightskip}{0pt plus 5cm}map$<$unsigned long,pair$<$Cryst\-Vector\-\_\-\-R\-E\-A\-L,string$>$ $>$ Obj\-Cryst\-::\-Refinable\-Obj\-::mvp\-Saved\-Values\-Set\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00078_a22adaed8c98377e45800e5d8624531a2}
