...
\label{a00070}\index{Obj\-Cryst\-::\-Powder\-Pattern\-Background@{Obj\-Cryst\-::\-Powder\-Pattern\-Background}}
...
\item 
{\bfseries Powder\-Pattern\-Background} (const {\bf Powder\-Pattern\-Background} \&)\label{a00070_a46496ee29e07d0c8949bfc45d77a4c3e}
...
void {\bf Import\-User\-Background} (const string \&filename)\label{a00070_ae68fc3a9883ca45c81a22119c28d9379}
...
void {\bfseries Set\-Interp\-Points} (const Cryst\-Vector\-\_\-\-R\-E\-A\-L tth, const Cryst\-Vector\-\_\-\-R\-E\-A\-L backgd)\label{a00070_afda9ea065efbed3fcfc783060de9b415}

\item 
const std\-::pair$<$ const \\*
Cryst\-Vector\-\_\-\-R\-E\-A\-L $\ast$, const \\*
Cryst\-Vector\-\_\-\-R\-E\-A\-L $\ast$ $>$ {\bfseries Get\-Interp\-Points} () const \label{a00070_a09b8b88c54f8916cea09ffd93bb5c18d}
...
virtual bool {\bf Has\-Powder\-Pattern\-Calc\-Variance} () const \label{a00070_abae616675aa5f8cf66eb0b788aedb43d}
...
void {\bfseries Init\-Ref\-Par\-List} ()\label{a00070_a5ec5ac4fd9ac7247fdb29c1b40e4369b}

\item 
void {\bfseries Init\-Options} ()\label{a00070_a9546d8c2c1de47d8eea570f20ab45bcb}

\item 
void {\bfseries Init\-Spline} () const \label{a00070_af795f71db9fadac9c6c142d9af6c8dcc}

\end{DoxyCompactItemize}
\subsubsection*{Protected Attributes}
\begin{DoxyCompactItemize}
\item 
int {\bf m\-Background\-Nb\-Point}\label{a00070_a1b41334ecbbbe337121f6041b7068e99}

\begin{DoxyCompactList}\small\item\em Number of fitting points for background. \end{DoxyCompactList}\item 
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Background\-Interp\-Point\-X}\label{a00070_a68740ba9e8c4348e2a6b2d96024436eb}
...
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Background\-Interp\-Point\-Intensity}\label{a00070_a942a33452d66e00cd155743a9c8c21e2}
...
\begin{DoxyCompactList}\small\item\em Vector of pixel values between each interval, for faster \doxyref{Cubic\-Spline}{p.}{a00032} calculations. \end{DoxyCompactList}\item 
{\bf Cubic\-Spline} {\bf mv\-Spline}
\begin{DoxyCompactList}\small\item\em Spline used for interpolation. \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Background\-Point}\label{a00070_ae26867d298bf99ee07d196b5636a144f}

\begin{DoxyCompactList}\small\item\em Modification of the interpolated points. \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Spline}\label{a00070_af2988bbeae93a4ebe62161bfb136a859}
...
R\-E\-A\-L {\bf m\-Model\-Variance}\label{a00070_afb62b2f85e9bab627f14265830d1ff09}
...
{\bf Ref\-Obj\-Opt} {\bf m\-Interpolation\-Model}\label{a00070_a8dcbfb135b47ce820d7a6500818c84fd}
...
\begin{DoxyCompactItemize}
\item 
class {\bfseries Powder\-Pattern}\label{a00070_a7b7565a5c419f2d4753446ff094a44cb}
...
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_ac9a022b49d583e8ae81e4d96e50cc9d8}
...
\doxyref{End\-Optimization()}{p.}{a00078_ab0035f6164cb24ace67b51b11993a851} must be called at the end of the optimization, the same number of time \doxyref{Begin\-Optimization()}{p.}{a00070_ac9a022b49d583e8ae81e4d96e50cc9d8} was called !
\end{DoxyNote}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00070_a563a5021d4d1dbbf7d5cec58f524c60a}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00070_af486465f3fa318d9d7737fb1347d0649}
...
\end{DoxyParamCaption}
)}\label{a00070_a874e0bed05f17df53ad6ddd3df989dc9}
...
\begin{DoxyParams}{Parameters}
{\em obj,\-:} & the object in which are parameters to be fixed. Normally this will be the \doxyref{Powder\-Pattern\-Background}{p.}{a00070} object itself, but it can also be the parameter list copied such as in a \doxyref{L\-S\-Q\-Num\-Obj}{p.}{a00046}. \\
\hline
\end{DoxyParams}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00070_a348238a43c30b1601eaa1c30503b56e2}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_afae084513270b7adf50954bec4037380}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_ae34c8b65496994cce5b6b73748d3a2b9}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_adb37c0a9b8e41e6dc11e6a9718c89bf5}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_a871e01608feb73589bb27f4375194630}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_a5bc997017cf1d95641b44021175c3dad}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_a48d8a351e2fcb8428a9af36c6a4fbf0f}
...
{}
\end{DoxyParamCaption}
)}\label{a00070_a0735ae2350ebce9320ebc2fd16dd94be}
...
The minimization will a maximum of 50 Simplex runs (see the \doxyref{Simplex\-Obj}{p.}{a00100} documentation), each with 200 cycles.

See the class documentation for \doxyref{Powder\-Pattern\-Background\-Bayesian\-Minimiser}{p.}{a00071}. \index{Obj\-Cryst\-::\-Powder\-Pattern\-Background@{Obj\-Cryst\-::\-Powder\-Pattern\-Background}!Prepare@{Prepare}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00070_aac7d53c229cd59c2c9d4c5de539a60e1}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00070_a6c6c5f75dc132609ba822337123edd1d}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_a02032467fb6485e05f0a1bbf74133833}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_af1a8228087bafd3c3ae0830b3d94df2a}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_a7747e4a20056c4756943319bc8ffba8d}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00070_a41f59111f35f92d0c3b99942606b234e}
...
\paragraph[{m\-Max\-Sin\-Theta\-Ov\-Lambda}]{\setlength{\rightskip}{0pt plus 5cm}R\-E\-A\-L Obj\-Cryst\-::\-Powder\-Pattern\-Background\-::m\-Max\-Sin\-Theta\-Ov\-Lambda\hspace{0.3cm}{\ttfamily [protected]}}\label{a00070_aca05bc94a86a737d8b744704478c2c24}
...
\paragraph[{m\-Point\-Order}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Vector\-\_\-long Obj\-Cryst\-::\-Powder\-Pattern\-Background\-::m\-Point\-Order\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00070_a1280a4f46ff6ba37182878507fab21f4}
...
\paragraph[{mv\-Spline}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Cubic\-Spline} Obj\-Cryst\-::\-Powder\-Pattern\-Background\-::mv\-Spline\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00070_a671b5004d363af3cd7efbe97b488ac33}
...
\paragraph[{mv\-Spline\-Pixel}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Vector\-\_\-\-R\-E\-A\-L Obj\-Cryst\-::\-Powder\-Pattern\-Background\-::mv\-Spline\-Pixel\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00070_a16f3af868232f0bbe8c4884ec1676518}


Vector of pixel values between each interval, for faster \doxyref{Cubic\-Spline}{p.}{a00032} calculations. 
