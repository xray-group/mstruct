(stars indicate priority/complexity \+: ($\ast$$\ast$$\ast$$\ast$$\ast$,$\ast$$\ast$) is urgent,fairly easy)\subsection{Outside features}\label{a00012_external}
...
\end{DoxyParagraph}
\subsection{Library Features}\label{a00012_general}
...
\end{DoxyParagraph}
\subsection{Internal Design of the Library}\label{a00012_internal}
...
\end{DoxyParagraph}
\subsection{Wild ideas (interesting possibilities, but no priority given)}\label{a00012_wild}
