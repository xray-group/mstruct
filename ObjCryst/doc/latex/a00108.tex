...
\label{a00108}\index{Obj\-Cryst\-::\-Stretch\-Mode\-Torsion@{Obj\-Cryst\-::\-Stretch\-Mode\-Torsion}}
...
\item 
{\bf Stretch\-Mode\-Torsion} ({\bf Mol\-Atom} \&at1, {\bf Mol\-Atom} \&at2, const {\bf Mol\-Dihedral\-Angle} $\ast$p\-Dihedral\-Angle)\label{a00108_a87d8b940172d8aaa8961d70edc891424}
...
virtual void {\bf Print} (ostream \&os, bool full=true) const \label{a00108_a09cb572292e22edc2561c4d521976c1e}

\begin{DoxyCompactList}\small\item\em Print one-\/line list of atoms moved. \end{DoxyCompactList}\item 
virtual void {\bf Stretch} (const R\-E\-A\-L change)\label{a00108_a38459c1fe17f977d8e7aa111e60fcb80}

\begin{DoxyCompactList}\small\item\em Move the atoms according to this mode. \end{DoxyCompactList}\item 
virtual void {\bf Random\-Stretch} (const R\-E\-A\-L amplitude)\label{a00108_a45af672b46859970f6f77f3734d973f0}
...
\begin{DoxyCompactItemize}
\item 
{\bf Mol\-Atom} $\ast$ {\bf mp\-Atom1}\label{a00108_a634c5b17f5b6fec260556256c8f8c6a2}

\begin{DoxyCompactList}\small\item\em The first atom. \end{DoxyCompactList}\item 
{\bf Mol\-Atom} $\ast$ {\bf mp\-Atom2}\label{a00108_a6efdb86745541ac989f8cd703d1919d0}
...
set$<$ {\bf Mol\-Atom} $\ast$ $>$ {\bf mv\-Rotated\-Atom\-List}\label{a00108_ad20b18eb2901e1f0c94af520c2defd1b}
...
This should be merged (or have an inheritance relation) with \doxyref{Mol\-Dihedral\-Angle}{p.}{a00053} 
...
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00108_abecf1074b05ba13fd938667399df110e}
...
\paragraph[{mp\-Dihedral\-Angle}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf Mol\-Dihedral\-Angle}$\ast$ Obj\-Cryst\-::\-Stretch\-Mode\-Torsion\-::mp\-Dihedral\-Angle}\label{a00108_a93128fa32715a53d1ecc6758283f8641}
