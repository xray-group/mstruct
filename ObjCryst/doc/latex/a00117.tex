...
\label{a00117}\index{Obj\-Cryst\-::\-Unit\-Cell@{Obj\-Cryst\-::\-Unit\-Cell}}
...
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{a00117}
\end{center}
\end{figure}
\subsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
{\bf Unit\-Cell} ()\label{a00117_a51e806f8efcbc6f9f01212ed6ba159c9}

\begin{DoxyCompactList}\small\item\em Default Constructor. \end{DoxyCompactList}\item 
{\bf Unit\-Cell} (const R\-E\-A\-L a, const R\-E\-A\-L b, const R\-E\-A\-L c, const string \&Space\-Group\-Id)
\begin{DoxyCompactList}\small\item\em \doxyref{Unit\-Cell}{p.}{a00117} Constructor (orthorombic) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \doxyref{Unit\-Cell}{p.}{a00117} Constructor (triclinic) \end{DoxyCompactList}\item 
{\bf Unit\-Cell} (const {\bf Unit\-Cell} \&old\-Cryst)\label{a00117_a891da67e4f9c2aab210b8b7b0b1986cd}

\begin{DoxyCompactList}\small\item\em \doxyref{Unit\-Cell}{p.}{a00117} copy constructor. \end{DoxyCompactList}\item 
{\bf $\sim$\-Unit\-Cell} ()\label{a00117_aab63f4f8527568531f015721a48b6da5}
...
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Lattice\-Par} () const \label{a00117_aa288a03401b377173b0e04918aadaf64}
...
\begin{DoxyCompactList}\small\item\em Get the 'B' matrix (\doxyref{Unit\-Cell\-::m\-B\-Matrix}{p.}{a00117_a091db52d0111d8e145a3834fd51dad14})for the \doxyref{Unit\-Cell}{p.}{a00117} (orthogonalization matrix for the given lattice, in the reciprocal space) \end{DoxyCompactList}\item 
const Cryst\-Matrix\-\_\-\-R\-E\-A\-L \& {\bf Get\-Orth\-Matrix} () const 
\begin{DoxyCompactList}\small\item\em Get the orthogonalization matrix (\doxyref{Unit\-Cell\-::m\-Orth\-Matrix}{p.}{a00117_a339a2f9f13a875944b88dbb29515e3b8})for the \doxyref{Unit\-Cell}{p.}{a00117} in real space. \end{DoxyCompactList}\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Metric\-Matrix} () const \label{a00117_a0e741b964c28c3cdb4b1268843ce4671}
...
\begin{DoxyCompactList}\small\item\em Prints some info about the \doxyref{Unit\-Cell}{p.}{a00117}. \end{DoxyCompactList}\item 
const {\bf Space\-Group} \& {\bf Get\-Space\-Group} () const \label{a00117_af2fb384b78f90b482b164d1975b471ed}

\begin{DoxyCompactList}\small\item\em Access to the \doxyref{Space\-Group}{p.}{a00102} object. \end{DoxyCompactList}\item 
{\bf Space\-Group} \& {\bf Get\-Space\-Group} ()\label{a00117_a0431c2c1fa2899ee8e40e8a5a6c262ba}

\begin{DoxyCompactList}\small\item\em Access to the \doxyref{Space\-Group}{p.}{a00102} object. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf Get\-Volume} () const \label{a00117_ac86797b54e6fbb48f9250f0636505d35}
...
\begin{DoxyCompactList}\small\item\em Init all \doxyref{Unit\-Cell}{p.}{a00117} parameters. \end{DoxyCompactList}\item 
...
{\bf Space\-Group} {\bf m\-Space\-Group}\label{a00117_a7901e4687d5f577e059be11a2e699e77}

\begin{DoxyCompactList}\small\item\em The space group of the \doxyref{Unit\-Cell}{p.}{a00117}. \end{DoxyCompactList}\item 
...
Cryst\-Matrix\-\_\-\-R\-E\-A\-L {\bf m\-B\-Matrix\-Invert}\label{a00117_ab46b7e57dac0df8ca67cda8e52fcc87d}
...
Cryst\-Matrix\-\_\-\-R\-E\-A\-L {\bf m\-Orth\-Matrix\-Invert}\label{a00117_a0fca2b4c0d50565d44a959a55ed9ee60}
...
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Lattice\-Par}\label{a00117_a8118ef7b2dda884b3562c5b8b0792c27}
...
)}\label{a00117_ade3fec2bf55893d193be14001bd74f72}


\doxyref{Unit\-Cell}{p.}{a00117} Constructor (orthorombic) 
...
\item[{const string \&}]{Space\-Group\-Id}
\end{DoxyParamCaption}
)}\label{a00117_a9bb20fbe0be4e8296d400eed4dc3ae3d}


\doxyref{Unit\-Cell}{p.}{a00117} Constructor (triclinic) 
...
\item[{R\-E\-A\-L \&}]{z}
\end{DoxyParamCaption}
) const}\label{a00117_ae20464d04ceb2f0647d20e414dbd6d47}
...
{}
\end{DoxyParamCaption}
) const}\label{a00117_a775a8aab4731aefd0f0c58ddd63a1e0b}


Get the 'B' matrix (\doxyref{Unit\-Cell\-::m\-B\-Matrix}{p.}{a00117_a091db52d0111d8e145a3834fd51dad14})for the \doxyref{Unit\-Cell}{p.}{a00117} (orthogonalization matrix for the given lattice, in the reciprocal space) 
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00117_ac3b3c2e007083bf6f329eb11a6b610d1}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_ad1f69a5fb8981a2cf0eeb6245728af6d}.
...
{}
\end{DoxyParamCaption}
) const}\label{a00117_a948453b5081a4ed078d3ca604aa4a3d2}
...
\end{DoxyParamCaption}
) const}\label{a00117_a39cb70f464aa82437ec3ac2821b21ab2}
...
{}
\end{DoxyParamCaption}
) const}\label{a00117_ae15303f8d50c3bad08c6c93c3f10d557}


Get the orthogonalization matrix (\doxyref{Unit\-Cell\-::m\-Orth\-Matrix}{p.}{a00117_a339a2f9f13a875944b88dbb29515e3b8})for the \doxyref{Unit\-Cell}{p.}{a00117} in real space. 
...
\end{DoxyParamCaption}
) const}\label{a00117_ae3896560b2c862ce0e5fab5d44e77f6e}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\label{a00117_a6a98cc147e6b4471d30ff6b736c95e42}


Init all \doxyref{Unit\-Cell}{p.}{a00117} parameters. 
...
\hline
{\em name,\-:} & name for the \doxyref{Unit\-Cell}{p.}{a00117}, \-: '(Ta\-Se4)2\-I' \\
\hline
\end{DoxyParams}


Reimplemented in {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_aefcd0d1032e5b93de47b4b93d530ed5b}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [private]}}\label{a00117_ae85e22d8f514315847ae326da5a57ba1}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}, {\ttfamily [virtual]}}\label{a00117_a12460955ce7bb73812c3f3f798d8bfd8}


Init options. 

Need only be done once per \doxyref{Unit\-Cell}{p.}{a00117}. 

Reimplemented in {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_a6f824ecc64553f3b3d15d0db9bf5982d}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{a00117_a50170ade8b76500a86b99cd6caa06808}


Prepare the refinable parameters list. 

This is called once when creating the \doxyref{Unit\-Cell}{p.}{a00117}. \index{Obj\-Cryst\-::\-Unit\-Cell@{Obj\-Cryst\-::\-Unit\-Cell}!Miller\-To\-Orthonormal\-Coords@{Miller\-To\-Orthonormal\-Coords}}
...
\item[{R\-E\-A\-L \&}]{z}
\end{DoxyParamCaption}
) const}\label{a00117_af6efcbafcd761c6f8f4953190e7024d0}
...
\item[{R\-E\-A\-L \&}]{z}
\end{DoxyParamCaption}
) const}\label{a00117_ad7bf6451efd13b4d326f0cdf9c5f5603}
...
\item[{R\-E\-A\-L \&}]{z}
\end{DoxyParamCaption}
) const}\label{a00117_a22de4f6b2443df36d79b2316fdd01436}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00117_adf564cd9521473be30d073d1660fa3ee}


Prints some info about the \doxyref{Unit\-Cell}{p.}{a00117}. 
...
Reimplemented in {\bf Obj\-Cryst\-::\-Crystal} \doxyref{}{p.}{a00027_ac4a7086d3757be4bbe2484f549a1b0fc}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{a00117_a82cd8866825c80b3d6bc34246fd3a761}
...
\paragraph[{m\-B\-Matrix}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Matrix\-\_\-\-R\-E\-A\-L Obj\-Cryst\-::\-Unit\-Cell\-::m\-B\-Matrix\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [private]}}\label{a00117_a091db52d0111d8e145a3834fd51dad14}
...
\paragraph[{m\-Cell\-Dim}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Vector\-\_\-\-R\-E\-A\-L Obj\-Cryst\-::\-Unit\-Cell\-::m\-Cell\-Dim\hspace{0.3cm}{\ttfamily [private]}}\label{a00117_a0fc905b26b1d9f140ed491b1a7b24234}
...
\paragraph[{m\-Clock\-Lattice\-Par\-Update}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Refinable\-Obj\-Clock} Obj\-Cryst\-::\-Unit\-Cell\-::m\-Clock\-Lattice\-Par\-Update\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [private]}}\label{a00117_aa1d9d1869aecdaf26451d066a6f60173}
...
\paragraph[{m\-Clock\-Metric\-Matrix}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Refinable\-Obj\-Clock} Obj\-Cryst\-::\-Unit\-Cell\-::m\-Clock\-Metric\-Matrix\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [private]}}\label{a00117_a5937ae62209bea154e50f6831de79853}
...
\paragraph[{m\-Constrain\-Lattice\-To\-Space\-Group}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Ref\-Obj\-Opt} Obj\-Cryst\-::\-Unit\-Cell\-::m\-Constrain\-Lattice\-To\-Space\-Group\hspace{0.3cm}{\ttfamily [private]}}\label{a00117_ab2efe02096ce9d38aeca69fd9315e6f3}
...
This is useful duting global optimization when searching the structure in a \doxyref{Unit\-Cell}{p.}{a00117} which has (or is expected to have) a known pseudo-\/crystallographic symmetry, to reduce dramatically the number of parameters. Of course for final refinement the 'real' symmetry should be imposed. \index{Obj\-Cryst\-::\-Unit\-Cell@{Obj\-Cryst\-::\-Unit\-Cell}!m\-Orth\-Matrix@{m\-Orth\-Matrix}}
\index{m\-Orth\-Matrix@{m\-Orth\-Matrix}!ObjCryst::UnitCell@{Obj\-Cryst\-::\-Unit\-Cell}}
\paragraph[{m\-Orth\-Matrix}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Matrix\-\_\-\-R\-E\-A\-L Obj\-Cryst\-::\-Unit\-Cell\-::m\-Orth\-Matrix\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [private]}}\label{a00117_a339a2f9f13a875944b88dbb29515e3b8}
