...
\label{a00072}\index{Obj\-Cryst\-::\-Powder\-Pattern\-Component@{Obj\-Cryst\-::\-Powder\-Pattern\-Component}}
...
\item 
{\bfseries Powder\-Pattern\-Component} (const {\bf Powder\-Pattern\-Component} \&)\label{a00072_a10afd347f725df06fa8fabf94ee9c90f}
...
\begin{DoxyCompactList}\small\item\em Get the \doxyref{Powder\-Pattern}{p.}{a00069} object which uses this component. \end{DoxyCompactList}\item 
{\bf Powder\-Pattern} \& {\bf Get\-Parent\-Powder\-Pattern} ()
\begin{DoxyCompactList}\small\item\em Get the \doxyref{Powder\-Pattern}{p.}{a00069} object which uses this component. \end{DoxyCompactList}\item 
virtual void {\bf Set\-Parent\-Powder\-Pattern} ({\bf Powder\-Pattern} \&)=0
\begin{DoxyCompactList}\small\item\em Set the \doxyref{Powder\-Pattern}{p.}{a00069} object which uses this component. \end{DoxyCompactList}\item 
...
virtual bool {\bf Has\-Powder\-Pattern\-Calc\-Variance} () const =0\label{a00072_a773d077df9d066f3d15631ec84ca15fd}
...
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Powder\-Pattern\-Calc} () const \label{a00072_a179247c07e05dcaa468ce149d9cd5a06}
...
\begin{DoxyCompactItemize}
\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Powder\-Pattern\-Calc\-Variance} () const \label{a00072_a96109dc93d23fdc2ec87b25e42254ae0}
...
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Clock\-Bragg\-Limits} () const \label{a00072_a3743a5978a853dacabb004096519b35f}
...
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Powder\-Pattern\-Integrated\-Calc}\label{a00072_a86c152ac7f6fca46572986ea99686ae0}

\begin{DoxyCompactList}\small\item\em The calculated powder pattern, integrated. \end{DoxyCompactList}\item 
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Powder\-Pattern\-Calc\-Variance}\label{a00072_a01a50aa4e4114acc999676cd8069d426}
...
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Powder\-Pattern\-Integrated\-Calc\-Variance}\label{a00072_aeaeac00300d33fa5d9ebae323143c6e2}
...
Cryst\-Vector\-\_\-long {\bf m\-Integrated\-Refl\-Limits}\label{a00072_ad0441f62b3b16e18f7cbdda6d89432cb}
...
bool {\bf m\-Is\-Scalable}\label{a00072_aa1729b95ee7b6fbdc3e6aa7a9ca94aad}

\begin{DoxyCompactList}\small\item\em Scalable ? (crystal phase = scalable, background= not scalable) \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Powder\-Pattern\-Calc}\label{a00072_aa64deb96cf54c504d9a24cdf209e9e0e}

\begin{DoxyCompactList}\small\item\em When was the powder pattern last computed ? \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Powder\-Pattern\-Integrated\-Calc}\label{a00072_adc8435a9476962ad2876a8cfbee5cde5}

\begin{DoxyCompactList}\small\item\em When was the 'integrated' powder pattern last computed ? \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Powder\-Pattern\-Variance\-Calc}\label{a00072_a503f89c2087ebd815e5df69961efb148}

\begin{DoxyCompactList}\small\item\em When was the powder pattern variance last computed ? \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Powder\-Pattern\-Integrated\-Variance\-Calc}\label{a00072_a4f1cc991dadf2cecfbd758c91b9cbd78}
...
{\bf Powder\-Pattern} $\ast$ {\bf mp\-Parent\-Powder\-Pattern}\label{a00072_ad565327e0f1e6af053d0766c39ced8a0}

\begin{DoxyCompactList}\small\item\em The \doxyref{Powder\-Pattern}{p.}{a00069} object in which this component is included. \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock\-Bragg\-Limits}\label{a00072_a7320d473c830fda04684c01a9cd1f5cb}

\begin{DoxyCompactList}\small\item\em Get last time the Bragg Limits were changed. \end{DoxyCompactList}\item 
list$<$ pair$<$ const R\-E\-A\-L,const \\*
string $>$ $>$ {\bf mv\-Label}\label{a00072_abe173118c67113339887a9831ad3a10f}
...
\begin{DoxyCompactItemize}
\item 
class {\bfseries Powder\-Pattern}\label{a00072_a7b7565a5c419f2d4753446ff094a44cb}
...
Most functions are protected, only to be accessed, internally or from the friend class \doxyref{Powder\-Pattern}{p.}{a00069}. 
...
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [pure virtual]}}\label{a00072_a8417ecb93009a9b7b9fccf074a9438d9}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a1f37b1e47c8bef989931fac08cf18849}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a563a5021d4d1dbbf7d5cec58f524c60a}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [pure virtual]}}\label{a00072_a24c4fb58e500cd669f3298475a31f72f}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_ae9e715bb230da8a3683adfee296288ad}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_af486465f3fa318d9d7737fb1347d0649}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [pure virtual]}}\label{a00072_a727488f859528b0a9b5da47973804e01}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_ab9e21f6f16d77e96e4b5bed47db82dca}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a348238a43c30b1601eaa1c30503b56e2}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00072_a5e797476d8d76ef797e1e8b51db9e8fb}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a74b02e35219c6bc18521e66719778881}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_afae084513270b7adf50954bec4037380}.
...
{}
\end{DoxyParamCaption}
) const}\label{a00072_a86b0e6ff842608be85b3465f4c179434}


Get the \doxyref{Powder\-Pattern}{p.}{a00069} object which uses this component. 
...
{}
\end{DoxyParamCaption}
)}\label{a00072_aa2b7cef2cb0c00f17b87efefa26448fd}
...
{}
\end{DoxyParamCaption}
) const}\label{a00072_a9307408216499bf327b919fd0a0141bf}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00072_a45258e9f9b44ff019bf53aa3dfb1a305}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a8003dc9bbaf67b5d95e443c20166b742}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_adb37c0a9b8e41e6dc11e6a9718c89bf5}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00072_ad67b39669fd0d336b01937ee81a59ddc}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a664e1f47391720d06ffaa2b10b0aaf49}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a871e01608feb73589bb27f4375194630}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00072_ac54b7ae5a177492de681afc2cbed72eb}


Get the integrated values of the powder pattern. 

\begin{DoxyNote}{Note}
\-: the integration intervals are those given by the parent \doxyref{Powder\-Pattern}{p.}{a00069}, so that all \doxyref{Powder\-Pattern\-Component}{p.}{a00072}'s intervals are taken into account
\end{DoxyNote}
This avoids explicitely calculating the full profile powder pattern. 

Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a2f2a745dcfa6cb7b7af4523b268827fe}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a5bc997017cf1d95641b44021175c3dad}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00072_ae721bd290b50aa9503bac419616a21c6}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_ae529ea1dab34388e88ba4a818ed48ca1}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a48d8a351e2fcb8428a9af36c6a4fbf0f}.
...
{}
\end{DoxyParamCaption}
) const}\label{a00072_aa0449b956187c242c3540a44e0a43e02}


Is this component scalable ? 

This is used by the \doxyref{Powder\-Pattern}{p.}{a00069} class, which fits all pattern components using scale factors. Some components may not need to be scaled\-: background components, which are assumed to be absolute. \index{Obj\-Cryst\-::\-Powder\-Pattern\-Component@{Obj\-Cryst\-::\-Powder\-Pattern\-Component}!Prepare@{Prepare}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [pure virtual]}}\label{a00072_a6a99877f0f9dec09fd5f596a7ddeb6f6}
This will be called by the parent \doxyref{Powder\-Pattern}{p.}{a00069} object, before calculating the first powder pattern. Or maybe it should be called automatically by the object itself... 

Reimplemented from {\bf Obj\-Cryst\-::\-Refinable\-Obj} \doxyref{}{p.}{a00078_a48d11671e7f8699f7bc24077585c5e0f}.



Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_ae19852383674ae3ab673748a30a8432a}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_aac7d53c229cd59c2c9d4c5de539a60e1}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [pure virtual]}}\label{a00072_a4731b5a64ee9aab6779e2ef323242fe5}
...
Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_a699af7ea523fca128032384b548ceef1}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a6c6c5f75dc132609ba822337123edd1d}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00072_a6b3dc911118c280dbbdcb7fb97acf980}


Set the \doxyref{Powder\-Pattern}{p.}{a00069} object which uses this component. 

This sets all necessary pattern parameters (2theta/tof range, wavelength, radiation type...) accordingly. 

Implemented in {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Diffraction} \doxyref{}{p.}{a00073_ab67953ad7f27c37334a6b557c2da1d73}, and {\bf Obj\-Cryst\-::\-Powder\-Pattern\-Background} \doxyref{}{p.}{a00070_a02032467fb6485e05f0a1bbf74133833}.
...
\paragraph[{m\-Powder\-Pattern\-Calc}]{\setlength{\rightskip}{0pt plus 5cm}Cryst\-Vector\-\_\-\-R\-E\-A\-L Obj\-Cryst\-::\-Powder\-Pattern\-Component\-::m\-Powder\-Pattern\-Calc\hspace{0.3cm}{\ttfamily [mutable]}, {\ttfamily [protected]}}\label{a00072_ae6e41d0a85e00cdf0a7d52f74dc20d4a}
