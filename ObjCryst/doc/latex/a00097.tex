...
\label{a00097}\index{Obj\-Cryst\-::\-Scattering\-Power@{Obj\-Cryst\-::\-Scattering\-Power}}


Abstract Base Class to describe the scattering power of any \doxyref{Scatterer}{p.}{a00092} component in a crystal.  


Inheritance diagram for Obj\-Cryst\-:\-:Scattering\-Power\-:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.666667cm]{a00097}
\end{center}
\end{figure}
\subsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
{\bfseries Scattering\-Power} (const {\bf Scattering\-Power} \&old)\label{a00097_a40d392b01f277a90affc2825ffa2e28d}
...
virtual void {\bfseries operator=} (const {\bf Scattering\-Power} \&rhs)\label{a00097_a1db56ac3b61b4f5d1f70dbf65fff114a}
...
\begin{DoxyCompactList}\small\item\em Get the Scattering factor for all reflections of a given \doxyref{Scattering\-Data}{p.}{a00096} object. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Get the temperature factor for all reflections of a given \doxyref{Scattering\-Data}{p.}{a00096} object. \end{DoxyCompactList}\item 
...
virtual bool {\bf Is\-Scattering\-Factor\-Anisotropic} () const \label{a00097_a0d099ca049eebbf23a31fb32b4229d4a}

\begin{DoxyCompactList}\small\item\em Is the scattering factor anisotropic ? \end{DoxyCompactList}\item 
virtual bool {\bf Is\-Temperature\-Factor\-Anisotropic} () const \label{a00097_a602947d2e968b88f208d3507bd8a093d}

\begin{DoxyCompactList}\small\item\em Is the thermic factor anisotropic ? \end{DoxyCompactList}\item 
virtual bool {\bf Is\-Resonant\-Scattering\-Anisotropic} () const \label{a00097_ac8f88b96383b0b97812913427d0c65f1}
...
R\-E\-A\-L {\bf Get\-Bij} (const size\-\_\-t \&i, const size\-\_\-t \&j) const \label{a00097_aab538c7888aa57c38236bd01c9252965}
...
virtual void {\bf Set\-Bij} (const size\-\_\-t \&i, const size\-\_\-t \&j, const R\-E\-A\-L new\-B)\label{a00097_a8c947f00897876d91f68617772a20dad}
...
bool {\bf Is\-Isotropic} () const \label{a00097_a05909fe082739c6be397299813418618}
...
long {\bf Get\-Nb\-Scattering\-Power} () const \label{a00097_af7cf02d1229e45220953b345a6f6d427}

\begin{DoxyCompactList}\small\item\em Total number of \doxyref{Scattering\-Power}{p.}{a00097} object. \end{DoxyCompactList}\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Last\-Change\-Clock} () const \label{a00097_aac5f03782e5b08b3e60254b1fe0aad4a}
...
const string \& {\bf Get\-Colour\-Name} () const \label{a00097_acbe6442c66fcb7760b2684ec4d9456cd}

\begin{DoxyCompactList}\small\item\em Get the (P\-O\-V-\/\-Ray) name associated to the color (if any) \end{DoxyCompactList}\item 
const float $\ast$ {\bf Get\-Colour\-R\-G\-B} () const \label{a00097_a5a992fe0ab82ddc79f184bbb12d6aaa0}
...
void {\bf Set\-Colour} (const string \&color\-Name)\label{a00097_ac48cb91ee4361a14d829227023479514}

\begin{DoxyCompactList}\small\item\em Set the colour from the associated P\-O\-V-\/\-Ray name. \end{DoxyCompactList}\item 
void {\bf Set\-Colour} (const float r, const float g, const float b)\label{a00097_a312da0ad4d8229baf7d6ab7ff9c45a3c}
...
R\-E\-A\-L {\bf Get\-Maximum\-Likelihood\-Nb\-Ghost\-Atom} () const \label{a00097_a23031fcb8c8c79d0e086da6aaadcd40c}
...
void {\bf Set\-Maximum\-Likelihood\-Nb\-Ghost\-Atom} (const R\-E\-A\-L nb)\label{a00097_aa3343885c4b3b9d41c386f7d8aaacd63}
...
virtual R\-E\-A\-L {\bfseries Get\-Formal\-Charge} () const \label{a00097_a04f10b6898e5242548a6980b99a55bb9}

\item 
virtual void {\bfseries Set\-Formal\-Charge} (const R\-E\-A\-L charge)\label{a00097_a98c9fe3af63a4093a354bb814730aa76}

\end{DoxyCompactItemize}
\subsubsection*{Protected Member Functions}
\begin{DoxyCompactItemize}
\item 
virtual void {\bfseries Init\-Ref\-Par\-List} ()=0\label{a00097_a963cfe56b67286007bb93c7962e72b5c}

\item 
virtual void {\bf Init} ()\label{a00097_ac39b1294c085edac4c7180b4373a73c0}
...
virtual void {\bf Init\-R\-G\-B\-Colour} ()\label{a00097_a24c0c49adab2efe6af63c4915d861577}
...
R\-E\-A\-L {\bf m\-Biso}\label{a00097_aad32a210a13475061a2cda7525e05501}

\begin{DoxyCompactList}\small\item\em Temperature isotropic B factor. \end{DoxyCompactList}\item 
bool {\bf m\-Is\-Isotropic}\label{a00097_a312928a0ead2f2bff84156e772752fe1}

\begin{DoxyCompactList}\small\item\em Is the scattering isotropic ? \end{DoxyCompactList}\item 
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-Beta}\label{a00097_a02a4524640e2d23805df26b114be680f}

\begin{DoxyCompactList}\small\item\em Anisotropic Beta(ij) \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} {\bf m\-Clock}\label{a00097_a7b2e1854b0799312da38819cebf13672}

\begin{DoxyCompactList}\small\item\em Clock. \end{DoxyCompactList}\item 
string {\bf m\-Colour\-Name}\label{a00097_a0726f45b1f31f338326a28345b57738e}

\begin{DoxyCompactList}\small\item\em Colour for this \doxyref{Scattering\-Power}{p.}{a00097} (from P\-O\-V\-Ray) \end{DoxyCompactList}\item 
float {\bf m\-Colour\-R\-G\-B} [3]\label{a00097_a00cf7e1fbe362a96be4a22c8b454fd29}

\begin{DoxyCompactList}\small\item\em Colour for this \doxyref{Scattering\-Power}{p.}{a00097} using R\-G\-B. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf m\-Maximum\-Likelihood\-Position\-Error}\label{a00097_a20aa001aad26734367838792eff09682}
...
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Maximum\-Likelihood\-Par\-Clock}\label{a00097_a727c82cdb03968dba28c5f7549860093}
...
) const}\label{a00097_abc78b680e9cd6a38b875731363978477}
...
{}
\end{DoxyParamCaption}
) const}\label{a00097_ac3e116b2d956c229b11c98c837e042d8}
...
{}
\end{DoxyParamCaption}
)}\label{a00097_ace567e5b32673e14521ae262388dfed6}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00097_ac31cc4135011046f93d49f4173aee3ee}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a87fcc8fe4871d1b9b6ec08af5f353657}, and {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a57e85d29926fe93da66041a43583e893}.
...
{}
\end{DoxyParamCaption}
) const}\label{a00097_ae3d48856abf5c8ef9dea6204309897bc}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00097_a854b51b9b08e96af0fe7986fe372c50c}
...
Implemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_ab979c1f31fd03b0f10f0afd625be722e}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a9bd142cc8112495d41393b4faffc4fcd}, and {\bf Obj\-Cryst\-::\-Global\-Scattering\-Power} \doxyref{}{p.}{a00041_a33c01c7512929a947e6489df41edf7b3}.
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00097_aae98160e01ecb2098cf4777126860aa5}
...
{}
\end{DoxyParamCaption}
) const}\label{a00097_a63af7f309f1d9e03245f84ba21b1dc4e}
...
{}
\end{DoxyParamCaption}
) const}\label{a00097_a34a36179228e07e92a85da9d17376649}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00097_ac44860aca21734844379ddec87622f7b}
...
Implemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a38cdad845523d408f473cdea050841a0}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a1f4b091f0990b959acb0645fd575a080}, and {\bf Obj\-Cryst\-::\-Global\-Scattering\-Power} \doxyref{}{p.}{a00041_aadef1e0a463f70f4f70dba3d12dba9ed}.
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00097_a9bc5d86bf76116f645b43d46f2a9771c}
...
\begin{DoxyParams}{Parameters}
{\em data,\-:} & the \doxyref{Scattering\-Data}{p.}{a00096} object, giving access to all the reflections, and a list of wavelengths. \\
\hline
{\em spg\-Sym\-Pos\-Index,\-:} & if the \doxyref{Scattering\-Power}{p.}{a00097} is anisotropic, then the different symmetrics will not have the same scattering power for all reflections. This parameter is the index of the symmetric position in the Spacegroup. If spg\-Sym\-Pos\-Index=-\/1, the isotropic values are returned. \\
\hline
\end{DoxyParams}
\begin{DoxyWarning}{Warning}
...
Implemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a18e0f4ec2008406f6b6f770abada9b88}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_aee221744487a1c29023399b71e855c06}, and {\bf Obj\-Cryst\-::\-Global\-Scattering\-Power} \doxyref{}{p.}{a00041_af3b5eefc24e2c60843793cdfbc240a11}.
...
\item[{const int}]{spg\-Sym\-Pos\-Index = {\ttfamily -\/1}}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00097_a42c1302254787d13b9e0f2210315291a}
...
Implemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a538841350c5a7147f7be607dd3ef5b72}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a064671bfd711ef108be7a1528e52cd46}, and {\bf Obj\-Cryst\-::\-Global\-Scattering\-Power} \doxyref{}{p.}{a00041_a9ddb16c057b744df58473fd2880baa3c}.
...
\item[{const int}]{spg\-Sym\-Pos\-Index = {\ttfamily -\/1}}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00097_af18f3eaaf45af87bc3a2a0ff21bc34b6}


Get the Scattering factor for all reflections of a given \doxyref{Scattering\-Data}{p.}{a00096} object. 

\begin{DoxyReturn}{Returns}
a vector with the scattering factor for all reflections, in the same order as in the \doxyref{Scattering\-Data}{p.}{a00096} object. This format is independent of the radiation type (X-\/\-Ray, neutron..). 
\end{DoxyReturn}

\begin{DoxyParams}{Parameters}
{\em data,\-:} & the \doxyref{Scattering\-Data}{p.}{a00096} object, giving access to all the reflections. \\
\hline
{\em spg\-Sym\-Pos\-Index,\-:} & if the \doxyref{Scattering\-Power}{p.}{a00097} is anisotropic, then the different symmetrics will not have the same scattering power for all reflections. This parameter is the index of the symmetric position in the Spacegroup. If spg\-Sym\-Pos\-Index=-\/1, the isotropic values are returned. \\
\hline
\end{DoxyParams}
...
Implemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a1c1733e6f6aab65fbe033b877cac5ae8}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a073f08b17ba89e0ac5ed8e1a61cb04fe}, and {\bf Obj\-Cryst\-::\-Global\-Scattering\-Power} \doxyref{}{p.}{a00041_acd525a54e45dc3c70fb5445b8b9b5a8c}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00097_a5cdd13d241974a6e6f0d3803256a3d10}
...
Reimplemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_a0b21c0253564cb40353171b182f50ecf}.
...
\item[{const int}]{spg\-Sym\-Pos\-Index = {\ttfamily -\/1}}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{a00097_a3df723db77380c82ecff5f7050490255}


Get the temperature factor for all reflections of a given \doxyref{Scattering\-Data}{p.}{a00096} object. 

\begin{DoxyReturn}{Returns}
a vector with the temperature factor for all reflections, in the same order as in the \doxyref{Scattering\-Data}{p.}{a00096} object. 
\end{DoxyReturn}
...
Implemented in {\bf Obj\-Cryst\-::\-Scattering\-Power\-Atom} \doxyref{}{p.}{a00098_aefe7a8b036c3f5a4a2b781b527dfa8c3}, {\bf Obj\-Cryst\-::\-Scattering\-Power\-Sphere} \doxyref{}{p.}{a00099_a3927291a20f5807c2ec6a9ae3627005d}, and {\bf Obj\-Cryst\-::\-Global\-Scattering\-Power} \doxyref{}{p.}{a00041_a48da59604bb5a35fdac09087bc0fcff4}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00097_a50b648d97ebb1ab97b39195b098eff50}
...
\item[{const R\-E\-A\-L}]{new\-B}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00097_a179266106b89bcbb4885f9f20ce315c3}
...
\end{DoxyParamCaption}
)}\label{a00097_aeba30efe61155572ffdada1121578bc9}
...
\paragraph[{m\-Dyn\-Pop\-Corr\-Index}]{\setlength{\rightskip}{0pt plus 5cm}long Obj\-Cryst\-::\-Scattering\-Power\-::m\-Dyn\-Pop\-Corr\-Index\hspace{0.3cm}{\ttfamily [protected]}}\label{a00097_a0266da1d92ec3d14989a2d4047710c4b}
...
\paragraph[{m\-Formal\-Charge}]{\setlength{\rightskip}{0pt plus 5cm}R\-E\-A\-L Obj\-Cryst\-::\-Scattering\-Power\-::m\-Formal\-Charge\hspace{0.3cm}{\ttfamily [protected]}}\label{a00097_a030be52e5ba5540bf068e6be4ccb190e}
...
\paragraph[{m\-Maximum\-Likelihood\-Nb\-Ghost}]{\setlength{\rightskip}{0pt plus 5cm}R\-E\-A\-L Obj\-Cryst\-::\-Scattering\-Power\-::m\-Maximum\-Likelihood\-Nb\-Ghost\hspace{0.3cm}{\ttfamily [protected]}}\label{a00097_a53eeb0a26003df0bcf604817e2fbadf7}
