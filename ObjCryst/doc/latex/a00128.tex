...
\label{a00128}\index{Obj\-Cryst\-::\-W\-X\-Field\-Name@{Obj\-Cryst\-::\-W\-X\-Field\-Name}}


A field with the name of a \doxyref{W\-X\-Cryst\-Obj}{p.}{a00122}.  
...
\item 
{\bfseries W\-X\-Field\-Name} (wx\-Window $\ast$parent, const string \&label, {\bf W\-X\-Cryst\-Obj} $\ast$owner, const int field\-\_\-id, const int hsize=50, bool is\-Editable=true)\label{a00128_a7d6ee70f302497016a1c7faaa3b65633}
...
void {\bf On\-Text} (wx\-Command\-Event \&W\-X\-U\-N\-U\-S\-E\-D(event))\label{a00128_adddf5bb83b5ccceed120466118a3a650}
...
const string {\bf Get\-Value} () const \label{a00128_a04bd6cfb6f8c71c236dee5de937c381e}
...
void {\bf Revert} ()\label{a00128_a59ce32e9b9860b6cc6a0833f9d96b753}
...
virtual void {\bf Validate\-User\-Input} ()\label{a00128_a6139dacad8add55be1b3edaf17c52f31}
...
virtual void {\bf Set\-Size} (int width, int height)\label{a00128_a9a2de3cc4be9b91672142f305e66384a}

\begin{DoxyCompactList}\small\item\em Change the size of the field (excluding the title) \end{DoxyCompactList}\item 
virtual void {\bf Set\-Tool\-Tip} (const wx\-String \&tip)\label{a00128_a81816b854a98c0a0b41f5e8ddb4f6ddc}
...
\begin{DoxyCompactItemize}
\item 
{\bf W\-X\-Cryst\-Obj} $\ast$ {\bf mp\-W\-X\-Obj}\label{a00128_aeba41442b5b3c426315c2278169a6a41}

\begin{DoxyCompactList}\small\item\em The \doxyref{W\-X\-Cryst\-Obj}{p.}{a00122} whose name is shown here. \end{DoxyCompactList}\item 
string {\bf m\-Value}\label{a00128_aa39d895ae2ddba6475338fe753a94465}

\begin{DoxyCompactList}\small\item\em Last name displayed. \end{DoxyCompactList}\item 
wx\-Text\-Ctrl $\ast$ {\bf mp\-Field}\label{a00128_a0d475cb9a61594ce430ce594f01a3829}
...
Updating must be done by the \doxyref{W\-X\-Cryst\-Obj}{p.}{a00122} owner. For a simple string field linked directly to a string, use \doxyref{Obj\-Cryst\-::\-W\-X\-Field\-String}{p.}{a00133} 
...
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00128_a538a45567f480e1716ca3b593a1d0ed2}
...
\end{DoxyParamCaption}
)}\label{a00128_aedb19a5c1028d7956a42ccc3b6864481}
...
\item[{const string \&}]{}
\end{DoxyParamCaption}
)}\label{a00128_a31c2d4ae66874976d03fb3dc1f61e781}
...
\item[{const bool}]{mutexlock = {\ttfamily false}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00128_a490d3cd6888b9fd6c59dabe031e17440}
...
\hline
\end{DoxyParams}
The idea is to only use a few Mutexes to lock data from the top objects (wx\-Refinable\-Obj,...), when calling \doxyref{Cryst\-Update()}{p.}{a00128_a538a45567f480e1716ca3b593a1d0ed2} and \doxyref{Update\-U\-I()}{p.}{a00128_a490d3cd6888b9fd6c59dabe031e17440}. As sub-\/objects (\doxyref{W\-X\-Field}{p.}{a00126},...) are only updated from within a top object, the mutex lock in the top object will also lock the data in the sub-\/objects. 
...
\paragraph[{m\-Is\-Self\-Updating}]{\setlength{\rightskip}{0pt plus 5cm}bool Obj\-Cryst\-::\-W\-X\-Field\-Name\-::m\-Is\-Self\-Updating\hspace{0.3cm}{\ttfamily [protected]}}\label{a00128_a55d08ae80f82be85b66e66c4ded8eeb5}
...
\paragraph[{m\-Value\-Old}]{\setlength{\rightskip}{0pt plus 5cm}string Obj\-Cryst\-::\-W\-X\-Field\-Name\-::m\-Value\-Old\hspace{0.3cm}{\ttfamily [protected]}}\label{a00128_a4df82f08ebf86ee9cbc981c57a197202}
