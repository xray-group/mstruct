...
\label{a00054}\index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}}


\doxyref{Molecule}{p.}{a00054} \-: class for complex scatterer descriptions using cartesian coordinates with bond length/angle restraints, and moves either of individual atoms or using torsion bonds.  
...
virtual void {\bf Print} () const \label{a00054_a5c4fde55689b7e76705d1f04005802c6}
...
virtual unsigned int {\bf Get\-Nb\-L\-S\-Q\-Function} () const \label{a00054_a1496167f3d3eae46a1f1eb49110808ce}

\begin{DoxyCompactList}\small\item\em Number of L\-S\-Q functions. \end{DoxyCompactList}\item 
virtual const Cryst\-Vector\-\_\-\-R\-E\-A\-L \& {\bf Get\-L\-S\-Q\-Calc} (const unsigned int) const \label{a00054_ab9b0b6172128e4aae0aa4a26e9024550}

\begin{DoxyCompactList}\small\item\em Get the current calculated value for the L\-S\-Q function. \end{DoxyCompactList}\item 
virtual const Cryst\-Vector\-\_\-\-R\-E\-A\-L \& {\bf Get\-L\-S\-Q\-Obs} (const unsigned int) const \label{a00054_a044e12d7bd85fc13552ce3ef24776af5}

\begin{DoxyCompactList}\small\item\em Get the observed values for the L\-S\-Q function. \end{DoxyCompactList}\item 
virtual const Cryst\-Vector\-\_\-\-R\-E\-A\-L \& {\bf Get\-L\-S\-Q\-Weight} (const unsigned int) const \label{a00054_ac4c7e12b5f9ed0ddfeddd68e85291a17}
...
virtual int {\bf Get\-Nb\-Component} () const \label{a00054_a8787cb87d65117d40a595162cdab141e}
...
{\bf Mol\-Atom} \& {\bfseries Get\-Atom} (unsigned int i)\label{a00054_a0fc6f489b5ca70ec72f0968068c409d7}

\item 
const {\bf Mol\-Atom} \& {\bfseries Get\-Atom} (unsigned int i) const \label{a00054_a73cd31a5e84043b21878c8e6131f528a}

\item 
{\bf Mol\-Atom} \& {\bfseries Get\-Atom} (const string \&name)\label{a00054_a7532113b6b8d93659e319883bd709cbc}

\item 
const {\bf Mol\-Atom} \& {\bfseries Get\-Atom} (const string \&name) const \label{a00054_ace9ed3d2234a31be6f44d560e99edd14}

\item 
vector$<$ {\bf Mol\-Atom} $\ast$ $>$\\*
\-::reverse\-\_\-iterator {\bf Find\-Atom} (const string \&name)
\begin{DoxyCompactList}\small\item\em Search a \doxyref{Mol\-Atom}{p.}{a00050} from its name. \end{DoxyCompactList}\item 
vector$<$ {\bf Mol\-Atom} $\ast$ $>$\\*
...
const std\-::vector$<$ {\bf Mol\-Atom} $\ast$ $>$ \& {\bfseries Get\-Atom\-List} () const \label{a00054_a61a315fb7ee03b2a96864342fe4600c5}

\item 
const std\-::vector$<$ {\bf Mol\-Bond} $\ast$ $>$ \& {\bfseries Get\-Bond\-List} () const \label{a00054_a275e909fe6ba8357e29b979f6840005c}

\item 
const std\-::vector\\*
$<$ {\bf Mol\-Bond\-Angle} $\ast$ $>$ \& {\bfseries Get\-Bond\-Angle\-List} () const \label{a00054_a3282f5961beef5a6369f4aa70d6272b7}

\item 
const std\-::vector\\*
$<$ {\bf Mol\-Dihedral\-Angle} $\ast$ $>$ \& {\bfseries Get\-Dihedral\-Angle\-List} () const \label{a00054_a95389aeb48405b4b4772c69e5edd9499}

\item 
std\-::vector$<$ {\bf Mol\-Atom} $\ast$ $>$ \& {\bfseries Get\-Atom\-List} ()\label{a00054_af437a692e431372f8bdb37d23baf97f4}

\item 
std\-::vector$<$ {\bf Mol\-Bond} $\ast$ $>$ \& {\bfseries Get\-Bond\-List} ()\label{a00054_a900e3d7d54b7d8481f5c24665a3dda3b}

\item 
std\-::vector$<$ {\bf Mol\-Bond\-Angle} $\ast$ $>$ \& {\bfseries Get\-Bond\-Angle\-List} ()\label{a00054_a66bce84293ff7457a68878281dea862a}

\item 
std\-::vector$<$ {\bf Mol\-Dihedral\-Angle} $\ast$ $>$ \& {\bfseries Get\-Dihedral\-Angle\-List} ()\label{a00054_a145da462c88c4859e3656872427dbdd4}

\item 
std\-::list\\*
$<$ {\bf Stretch\-Mode\-Bond\-Length} $>$ \& {\bfseries Get\-Stretch\-Mode\-Bond\-Length\-List} ()\label{a00054_a2bde766df8213037d92110e1d61404e5}

\item 
std\-::list$<$ {\bf Stretch\-Mode\-Bond\-Angle} $>$ \& {\bfseries Get\-Stretch\-Mode\-Bond\-Angle\-List} ()\label{a00054_a3c84c2ee25cd4207b3b0033421382d5d}

\item 
std\-::list$<$ {\bf Stretch\-Mode\-Torsion} $>$ \& {\bfseries Get\-Stretch\-Mode\-Torsion\-List} ()\label{a00054_aef5aa02c67aef3248c36c86719dd0f75}

\item 
const std\-::list\\*
$<$ {\bf Stretch\-Mode\-Bond\-Length} $>$ \& {\bfseries Get\-Stretch\-Mode\-Bond\-Length\-List} () const \label{a00054_a07fa91c73992177983dc99bab7acd61c}

\item 
const std\-::list\\*
$<$ {\bf Stretch\-Mode\-Bond\-Angle} $>$ \& {\bfseries Get\-Stretch\-Mode\-Bond\-Angle\-List} () const \label{a00054_a60e4c6791d3f45cb18e9895ac272a673}

\item 
const std\-::list\\*
$<$ {\bf Stretch\-Mode\-Torsion} $>$ \& {\bfseries Get\-Stretch\-Mode\-Torsion\-List} () const \label{a00054_a5b08fa7fb5aff3a909e9c836cce6e8ad}
...
void {\bf Restraint\-Status} (ostream \&os) const \label{a00054_ae7311bdcb3ce15284228bfa2ab140e86}
...
$<$ {\bf Mol\-Atom} $\ast$ $>$ $>$ \& {\bf Get\-Connectivity\-Table} ()\label{a00054_ac558aa9940aec9e33ae710fb45b3d156}

\begin{DoxyCompactList}\small\item\em Get the connectivity table. \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} \& {\bf Get\-Bond\-List\-Clock} ()\label{a00054_a5ab539b95ffd60978ae7545ec10cc85b}

\begin{DoxyCompactList}\small\item\em get the clock associated to the list of bonds \end{DoxyCompactList}\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Bond\-List\-Clock} () const \label{a00054_ac754cabe98638a6f9efd0bf63a667c03}

\begin{DoxyCompactList}\small\item\em get the clock associated to the list of bonds \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} \& {\bf Get\-Atom\-Position\-Clock} ()\label{a00054_a46f35ddb18b731cfbb104d45ed96cdc7}

\begin{DoxyCompactList}\small\item\em Get the clock associated to the atomic positions. \end{DoxyCompactList}\item 
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Atom\-Position\-Clock} () const \label{a00054_a8c0a4e5e8fbdd2190c2838be9d4ea42e}

\begin{DoxyCompactList}\small\item\em Get the clock associated to the atomic positions. \end{DoxyCompactList}\item 
{\bf Refinable\-Obj\-Clock} \& {\bf Get\-Rigid\-Group\-Clock} ()\label{a00054_a5d5be56a81d49a3e067957b6e959b477}
...
const {\bf Refinable\-Obj\-Clock} \& {\bf Get\-Rigid\-Group\-Clock} () const \label{a00054_ae6b950305c66f518df22e52eb6e1661a}

\begin{DoxyCompactList}\small\item\em Get the clock associated to the list of rigid groups (clicked also whenever a rigid group is modified) \end{DoxyCompactList}\item 
void {\bf Rigidify\-With\-Dihedral\-Angles} ()
\begin{DoxyCompactList}\small\item\em Add dihedral angles so as to rigidify the \doxyref{Molecule}{p.}{a00054}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Stretch a bond, while respecting the \doxyref{Restraint}{p.}{a00088} (if any). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em change a bond angle, while respecting the \doxyref{Restraint}{p.}{a00088} (if any). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Change a dihedral angle, while respecting the \doxyref{Restraint}{p.}{a00088} (if any). \end{DoxyCompactList}\item 
const {\bf Mol\-Atom} $\ast$ {\bf Get\-Center\-Atom} () const 
\begin{DoxyCompactList}\small\item\em Get the atom defining the origin of the \doxyref{Molecule}{p.}{a00054} Equal to 0 if no atom as been set. \end{DoxyCompactList}\item 
void {\bf Set\-Center\-Atom} (const {\bf Mol\-Atom} \&at)
\begin{DoxyCompactList}\small\item\em Get the atom defining the origin of the \doxyref{Molecule}{p.}{a00054} Equal to 0 if no atom as been set. \end{DoxyCompactList}\item 
const std\-::vector$<$ {\bf Mol\-Z\-Atom} $>$ \& {\bf As\-Z\-Matrix} (const bool keeporder) const 
\begin{DoxyCompactList}\small\item\em \doxyref{Molecule}{p.}{a00054} as Z-\/matrix. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Tune the rotation amplitude for free torsions and for the overall \doxyref{Molecule}{p.}{a00054} Rotation. \end{DoxyCompactList}\item 
...
void {\bf Build\-Stretch\-Mode\-Bond\-Length} ()\label{a00054_abb51819a0eae8b612fb4007ffa16d2b7}

\begin{DoxyCompactList}\small\item\em Build the groups of atoms moved when stretching a bond length, while respecting the \doxyref{Molecule}{p.}{a00054} restraints. \end{DoxyCompactList}\item 
void {\bf Build\-Stretch\-Mode\-Bond\-Angle} ()\label{a00054_a3d507a4e25612a7412cbcc84b5a831ae}

\begin{DoxyCompactList}\small\item\em Build the groups of atoms moved when changing a bond angle, while respecting the \doxyref{Molecule}{p.}{a00054} restraints. \end{DoxyCompactList}\item 
void {\bf Build\-Stretch\-Mode\-Torsion} ()\label{a00054_a18d44782b4141dfab334250967d202ad}

\begin{DoxyCompactList}\small\item\em Build the groups of atoms moved when changing a dihedral angle, while respecting the \doxyref{Molecule}{p.}{a00054} restraints. \end{DoxyCompactList}\item 
void {\bf Build\-Stretch\-Mode\-Twist} ()
\begin{DoxyCompactList}\small\item\em Build the groups of atoms used to twist internally the \doxyref{Molecule}{p.}{a00054}, e.\-g. \end{DoxyCompactList}\item 
void {\bf Build\-Stretch\-Mode\-Groups} ()
\begin{DoxyCompactList}\small\item\em Separate \doxyref{Stretch\-Mode}{p.}{a00104} that break more than their assigned restraint from others. \end{DoxyCompactList}\item 
...
void {\bf Update\-Scatt\-Comp\-List} () const \label{a00054_a2807a35e4746ca9762c009bedb9d02ef}

\begin{DoxyCompactList}\small\item\em Update the \doxyref{Molecule\-::m\-Scatt\-Comp\-List}{p.}{a00054_ae681f50b04c32c7139727c675dc04b67} from the cartesian coordinates of all atoms, and the orientation parameters. \end{DoxyCompactList}\item 
void {\bf Init\-Options} ()\label{a00054_a15f72c789ad6e4cdae3a667d3d81e7eb}
...
void {\bf Flip\-Atom\-Group} (const {\bf Flip\-Group} \&)\label{a00054_a69fa14ccb89d13905370e0a75b1e83ff}

\begin{DoxyCompactList}\small\item\em Flip a group of atom. See \doxyref{Molecule\-::\-Flip\-Group}{p.}{a00034}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Base Rotation amplitude (in radians) for the \doxyref{Molecule}{p.}{a00054}, so that the average atomic displacement is equal to 0.\-1 A. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bfseries m\-Base\-Rotation\-Amplitude}\label{a00054_a1c0fdb65e11dc8c46c525b18826e013c}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Atom\-List}\label{a00054_a813452a36a4706a6590ec8be5e50d691}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Bond\-List}\label{a00054_a4276d3c873b3b0a0c86fbaef9f362403}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Bond\-Angle\-List}\label{a00054_a89305fe20d24689db9cef6165300cb3c}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Dihedral\-Angle\-List}\label{a00054_a52cdc04f8a7e0b60f86c1ec6e1dd9c00}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Rigid\-Group}\label{a00054_a031fb163482a63573aa2c0abb721a40c}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Atom\-Position}\label{a00054_a779328aa75fbd492d25d8f1e78ba3120}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Atom\-Scatt\-Pow}\label{a00054_aaa968c9d6b66e7f43784b6373333939d}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Orientation}\label{a00054_a9bd4e0dabed314962e489a29ed20a33c}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Log\-Likelihood}\label{a00054_a853e81d1fd9916d2a8e6cfee07415f7a}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Connectivity\-Table}\label{a00054_a5ab45bcd6837946dde8ef134874ae02b}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Ring\-List}\label{a00054_ab19b748ec7e4ead2947027b2f38b60e2}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Rotor\-Group}\label{a00054_abdfb80e948dc91137f5c568c99b1554a}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Flip\-Group}\label{a00054_a9654156a7376a5265c6555c23fa7316c}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Stretch\-Mode\-Bond\-Length}\label{a00054_a0320d6fc63fdd2d3454f6c93e21fb82d}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Stretch\-Mode\-Bond\-Angle}\label{a00054_ae641b2ae58267ce842c21e9e2c631a7e}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Stretch\-Mode\-Torsion}\label{a00054_ae932e4a8a69c7fb3422b703854478fc2}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-Stretch\-Mode\-Twist}\label{a00054_a83e297fa4cd4f1bebe17b9cf26838b7f}

\item 
{\bf Refinable\-Obj\-Clock} {\bfseries m\-Clock\-M\-D\-Atom\-Group}\label{a00054_acaeac88a7cea8c699fecb137337e9f2d}

\item 
unsigned long {\bfseries m\-Local\-Param\-Set}\label{a00054_ad176581e146e508869e67776f0e2e3d2}

\item 
unsigned long {\bfseries m\-Random\-Conform\-Change\-Nb\-Test}\label{a00054_a6fe920696fe0d0f811e35fe677c7b664}

\item 
unsigned long {\bfseries m\-Random\-Conform\-Change\-Nb\-Accept}\label{a00054_a3a52a7e8ab51acbe58c21e5f2fac2f21}

\item 
R\-E\-A\-L {\bfseries m\-Random\-Conform\-Change\-Temp}\label{a00054_a78242220a03384972970306eab3c84cc}

\item 
R\-E\-A\-L {\bfseries m\-Last\-Log\-Like}\label{a00054_ae424310a32f3ed915c33524e9c325549}

\item 
bool {\bfseries m\-Is\-Self\-Optimizing}\label{a00054_a3a266d6dc8d55ee94717b0f2137f20ad}
...
\begin{DoxyCompactList}\small\item\em Option to optimize the \doxyref{Molecule}{p.}{a00054}'s orientation. \end{DoxyCompactList}\item 
{\bf Ref\-Obj\-Opt} {\bf m\-Molecule\-Center}\label{a00054_a4ac986f017f968e59af58297b4a50d7f}

\begin{DoxyCompactList}\small\item\em Option to choose the center of rotation of the \doxyref{Molecule}{p.}{a00054} for the global orientation either as the geometrical center, or as a given atom. \end{DoxyCompactList}\item 
const {\bf Mol\-Atom} $\ast$ {\bf mp\-Center\-Atom}\label{a00054_a924f7062c1e35790e152a35166121266}

\begin{DoxyCompactList}\small\item\em \doxyref{Atom}{p.}{a00015} chosen as center of rotation, if m\-Rotation\-Center is set to use an atom rather than the geometrical center. \end{DoxyCompactList}\item 
...
list$<$ {\bf Flip\-Group} $>$ {\bf mv\-Flip\-Group}\label{a00054_a79ffe8ba3222a5f4a56fd9f2447c8fd7}

\begin{DoxyCompactList}\small\item\em The list of Flip\-Groups. \end{DoxyCompactList}\item 
list$<$ {\bf Stretch\-Mode\-Bond\-Length} $>$ {\bf mv\-Stretch\-Mode\-Bond\-Length}\label{a00054_aa3e38a39a6a392456c03f320e1bdaffa}

\begin{DoxyCompactList}\small\item\em List of \doxyref{Stretch\-Mode\-Bond\-Length}{p.}{a00106}. \end{DoxyCompactList}\item 
list$<$ {\bf Stretch\-Mode\-Bond\-Angle} $>$ {\bf mv\-Stretch\-Mode\-Bond\-Angle}\label{a00054_a5673efb9ae9ffc238f25c62805825c63}

\begin{DoxyCompactList}\small\item\em List of \doxyref{Stretch\-Mode\-Bond\-Length}{p.}{a00106}. \end{DoxyCompactList}\item 
list$<$ {\bf Stretch\-Mode\-Torsion} $>$ {\bf mv\-Stretch\-Mode\-Torsion}\label{a00054_a878336f175d85a68d55804ad43a453dc}

\begin{DoxyCompactList}\small\item\em List of \doxyref{Stretch\-Mode\-Bond\-Length}{p.}{a00106}. \end{DoxyCompactList}\item 
list$<$ {\bf Stretch\-Mode\-Twist} $>$ {\bf mv\-Stretch\-Mode\-Twist}\label{a00054_a53def8e47e265fc3dd62af4b07997bd1}

\begin{DoxyCompactList}\small\item\em List of \doxyref{Stretch\-Mode\-Twist}{p.}{a00109}. \end{DoxyCompactList}\item 
std\-::list$<$ {\bf Stretch\-Mode} $\ast$ $>$ {\bf mvp\-Stretch\-Mode\-Free}\label{a00054_a215591f48317322bb1b9203ebad4a011}

\begin{DoxyCompactList}\small\item\em Groups of \doxyref{Stretch\-Mode}{p.}{a00104} not breaking any restraint (unless the one they are associated to) \end{DoxyCompactList}\item 
std\-::list$<$ {\bf Stretch\-Mode} $\ast$ $>$ {\bf mvp\-Stretch\-Mode\-Not\-Free}\label{a00054_ae87a1cece989dc3d433eb7fad925c5de}

\begin{DoxyCompactList}\small\item\em Groups of \doxyref{Stretch\-Mode}{p.}{a00104} breaking restraints (beyond the one they are associated to) \end{DoxyCompactList}\item 
list$<$ {\bf M\-D\-Atom\-Group} $>$ {\bf mv\-M\-D\-Atom\-Group}\label{a00054_a4a3a91c91753e90de67341701df7e081}
...
std\-::set$<$ {\bf Mol\-Atom} $\ast$ $>$ {\bf mv\-M\-D\-Full\-Atom\-Group}\label{a00054_af3e1420d9c1c4cc3be0e58c5834130e7}
...
R\-E\-A\-L {\bf m\-M\-D\-Move\-Freq}\label{a00054_aee36f14d21f12d10581eaaf689136304}

\begin{DoxyCompactList}\small\item\em Frequency of using molecular dynamics move during \doxyref{Global\-Opt\-Random\-Move()}{p.}{a00054_a11e623f6482b468f6dd05fc0ab2bbb24} \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf m\-M\-D\-Move\-Energy}\label{a00054_a600a62199c1e9297d39a53848a155310}
...
std\-::vector$<$ {\bf Mol\-Z\-Atom} $>$ {\bf m\-As\-Z\-Matrix}\label{a00054_a45e0d1e1d54f4474158f270571957d4a}

\begin{DoxyCompactList}\small\item\em The \doxyref{Molecule}{p.}{a00054}, as a lightweight Z\-Matrix, for export purposes. \end{DoxyCompactList}\item 
R\-E\-A\-L {\bf m\-Log\-Likelihood}\label{a00054_aca5a25791960a8aa011c1cfa902c589a}
...
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-L\-S\-Q\-Calc}\label{a00054_a9e9be5fe3d3037cdf690df16235e370d}
...
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-L\-S\-Q\-Obs}\label{a00054_a6202acc4d02c90999f008c089bf1b21e}
...
Cryst\-Vector\-\_\-\-R\-E\-A\-L {\bf m\-L\-S\-Q\-Weight}\label{a00054_a7305a71a61c7ceedaf09b28a0d1ed64d}
...
the parametrization is very different from \doxyref{Z\-Scatterer}{p.}{a00163}\-: we keep a list of x,y,z which do not use limits (they must not), but the coordinates must be restrained or constrained from the expected bond lengths, angles and dihedral angles. The list of parameters is re-\/created in \doxyref{Begin\-Optimization()}{p.}{a00054_a5fbdadb37966f382a6e33150285819dc} (except for the global x y z parameters for the global position of the \doxyref{Molecule}{p.}{a00054}, in fractionnal coordinates).
...
)}\label{a00054_ad4132a293e7f253c730676ed3720f961}
...
\end{DoxyParamCaption}
)}\label{a00054_a896c80a621aa990de3d36e214965cd49}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_ae61d3a9a72c73cd087e330b3c4cdf0be}
...
\end{DoxyParamCaption}
)}\label{a00054_a7b193eac062233b758887cba671706f7}
...
\item[{const bool}]{update\-Display = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_aa37feb3abde7ca0ff6453b97d910800f}
...
\item[{const bool}]{update\-Display = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a25132c259da4d0bd739ff0ffc008575e}
...
\item[{const bool}]{update\-Display = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_aae30adce9fdd16e42cab4f8e434f01cf}
...
\item[{const bool}]{update\-Display = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a8c61827ad3303aca5c0db6698a5f9e06}


Add a rigid group of atoms. 

See \doxyref{Molecule\-::mv\-Rigid\-Group}{p.}{a00054_a43939b3e3ad83065cf7ccb6065a53a12} \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!As\-Z\-Matrix@{As\-Z\-Matrix}}
...
\end{DoxyParamCaption}
) const}\label{a00054_a3ce93bef9ea4da4d5e0cd47e62418a97}


\doxyref{Molecule}{p.}{a00054} as Z-\/matrix. 


\begin{DoxyParams}{Parameters}
{\em keeporder,\-:} & if true, the order of the atoms is exactly the same as in the \doxyref{Molecule}{p.}{a00054}. \\
\hline
\end{DoxyParams}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a5fbdadb37966f382a6e33150285819dc}
...
\doxyref{End\-Optimization()}{p.}{a00054_aec0a3ba0d08fdfed38cc757efb635ffb} must be called at the end of the optimization, the same number of time \doxyref{Begin\-Optimization()}{p.}{a00054_a5fbdadb37966f382a6e33150285819dc} was called !
\end{DoxyNote}
...
\end{DoxyParamCaption}
)}\label{a00054_ad6e27c1557962b32355eeadf1bf155d3}


change a bond angle, while respecting the \doxyref{Restraint}{p.}{a00088} (if any). 
...
\item[{const bool}]{respect\-Restraint = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_ad7bfddcdf21c1214c5a70c84fc54cdb0}


Stretch a bond, while respecting the \doxyref{Restraint}{p.}{a00088} (if any). 
...
{}
\end{DoxyParamCaption}
) const}\label{a00054_ac52190dc78f14df37e9bc5b3c9d713c2}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_aca2ed46d26209807d587722d131c6315}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a0944a68727d85bee4ec0cce453cb451c}
...
These atoms (if they are not in a rigid group) are stored in a \doxyref{M\-D\-Atom\-Group}{p.}{a00049} so that they can still move using molecular dynamics.

{\bfseries this} should be called after \doxyref{Build\-Stretch\-Mode\-Groups()}{p.}{a00054_a83b7b9bac2ce9fe7b310b5267232b1ca}, to make sure the list of free/non-\/free stretch mode has been built. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Build\-Ring\-List@{Build\-Ring\-List}}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a9623bff2259d45c162ed28af73974f5a}
...
\begin{DoxyNote}{Note}
So far this is a const method as the ring list just reflects the bond list and therefore is mutable (see \doxyref{Molecule\-::mv\-Ring}{p.}{a00054_a35cb61305129b6bbda4a0bb014b2c90e})... but maybe this could change... 
\end{DoxyNote}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a3642fa8104faa1ce84a977600f9d1aeb}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a83b7b9bac2ce9fe7b310b5267232b1ca}


Separate \doxyref{Stretch\-Mode}{p.}{a00104} that break more than their assigned restraint from others. 

See \doxyref{Molecule\-::mvp\-Stretch\-Mode\-Free}{p.}{a00054_a215591f48317322bb1b9203ebad4a011} and \doxyref{Molecule\-::mvp\-Stretch\-Mode\-Not\-Free}{p.}{a00054_ae87a1cece989dc3d433eb7fad925c5de} \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Build\-Stretch\-Mode\-Twist@{Build\-Stretch\-Mode\-Twist}}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a7f4c6bf6e5be59780cb7844e53711fb3}


Build the groups of atoms used to twist internally the \doxyref{Molecule}{p.}{a00054}, e.\-g. 
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a96728865d25881151b7010d3eaf4ec0f}
so-\/called Virtual copy constructor, needed to make copies of arrays of Scatterers 

Implements {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a4d374adcff97163a24492d362f6def73}.
...
\item[{const bool}]{respect\-Restraint = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_afd88ae76ab528b5dc37f9d2527353904}


Change a dihedral angle, while respecting the \doxyref{Restraint}{p.}{a00088} (if any). 
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_aec0a3ba0d08fdfed38cc757efb635ffb}
...
\item[{const string \&}]{name}
\end{DoxyParamCaption}
)}\label{a00054_a20b6239624acf37e771e29c002f63618}


Search a \doxyref{Mol\-Atom}{p.}{a00050} from its name. 
...
\item[{const string \&}]{name}
\end{DoxyParamCaption}
) const}\label{a00054_a10cb2cff89dd623e288cfa3376acfcfa}
...
\item[{const {\bf Mol\-Atom} \&}]{}
\end{DoxyParamCaption}
) const}\label{a00054_ac121a84c148439786581a103eef4d958}
...
\item[{const {\bf Mol\-Atom} \&}]{}
\end{DoxyParamCaption}
)}\label{a00054_a099aadd8edb91f148a174333b1636fb5}
...
\end{DoxyParamCaption}
) const}\label{a00054_aa94113e3d0ca15f5a3acbc573198fd59}
...
\end{DoxyParamCaption}
) const}\label{a00054_adb251aaa9a4f9e4e1b7e949e2fab73e4}
...
{}
\end{DoxyParamCaption}
) const}\label{a00054_a58e298d1cefcf677748b9c6807956f4a}


Get the atom defining the origin of the \doxyref{Molecule}{p.}{a00054} Equal to 0 if no atom as been set. 
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a7f0f1ae6670032f5afc9ccf65d45f8c4}
...
Reimplemented from {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a374fc1bb2887ab1f61d456326d97c05f}.
...
\item[{const int}]{i}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a8dae19447740afaa1780e39a61f625c9}


Name for the i-\/th component of this scatterer. 

If the component is an \doxyref{Atom}{p.}{a00015}, Then the name is that of the atom. Else, it is the name of the scatterer plus the component number in the scatterer plus the name of the \doxyref{Scattering\-Power}{p.}{a00097}. \begin{DoxyNote}{Note}
...
Implements {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a42bdf508da6a90859a5a61e16c27d47e}.
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a1c0e8ad2410035c07c4be88315554f3f}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_adef00ca72bec0e4553bbfba0852e1ba1}
...
{}
\end{DoxyParamCaption}
) const}\label{a00054_aa0e2192321dc993ba78fb84d7502e2eb}


List of rigid group of atoms. 

See \doxyref{Molecule\-::mv\-Rigid\-Group}{p.}{a00054_a43939b3e3ad83065cf7ccb6065a53a12} \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Get\-Rigid\-Group\-List@{Get\-Rigid\-Group\-List}}
\index{Get\-Rigid\-Group\-List@{Get\-Rigid\-Group\-List}!ObjCryst::Molecule@{Obj\-Cryst\-::\-Molecule}}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_afab17b6b5416c25a1a89b492017a590c}


List of rigid group of atoms. 

See \doxyref{Molecule\-::mv\-Rigid\-Group}{p.}{a00054_a43939b3e3ad83065cf7ccb6065a53a12} \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Get\-Scattering\-Component\-List@{Get\-Scattering\-Component\-List}}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a3ac17bd45a709c82d9a4d304fde09b88}


Get the list of all scattering components for this scatterer. 

This is the most important function of this class, giving the list of scattering positions along with the associated \doxyref{Scattering\-Power}{p.}{a00097}. 

Implements {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_aca0e08e3793cc69d31fce53e481c2a67}.
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a00aa7620326d8663b1f4e1bd9237ffb8}
Create an Open\-G\-L Display List of the scatterer. This should only be called by a \doxyref{Crystal}{p.}{a00027} object.


\begin{DoxyParams}{Parameters}
{\em no\-Symmetrics,\-:} & if false (the default), then all symmetrics are shown in the 3\-D display, within the limits defined by the min/max parameters \textbackslash{} param x\-Min,x\-Max,y\-Min,y\-Max,z\-Min,z\-Max\-: in fractionnal coordinates, the region in which we want scaterrer to be displayed. The test is made on the center of the scatterer (eg a \doxyref{Z\-Scatterer}{p.}{a00163} (molecule) will not be 'cut' on the border). \\
\hline
...
Implements {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a4eaf9cf9780bef83e40155810db120a0}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a11e623f6482b468f6dd05fc0ab2bbb24}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_ad96fe78688ce898dc9aeffcc23523967}
Prepare refinable parameters for the scatterer object 

Implements {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a45ef328b68a0a68c0228beefc25cda7f}.
...
\end{DoxyParamCaption}
)}\label{a00054_a9a43c803d62dc4f5f3b7852bbd75c939}
...
\hline
{\em vb,va,vd,\-:} & vector of bond, bond angle and dihedral angle restraints to be taken into account. If these are empty, the full list of restraints of the \doxyref{Molecule}{p.}{a00054} are taken into account, including rigid groups. If they are not empty, then it is assumed that no atom moved belongs to a rigid group. \\
\hline
{\em vr,\-:} & initial speed for the angular and translation parameters of rigid groups included in the evolution. For each entry of the map the first \doxyref{X\-Y\-Z}{p.}{a00159} coordinates are the speed for \doxyref{Rigid\-Group\-::m\-X}{p.}{a00089_abda5125459a21cc5534c90d9516312e9},m\-Y,m\-Z, and the second are the speed for the angular coordinates of the quaternion Q1,Q2,Q3 \\
\hline
...
\end{DoxyParamCaption}
)}\label{a00054_a8e070563a06e9c375b3b26d2e5828c54}
...
\end{DoxyParamCaption}
)}\label{a00054_ac275665ed11daea220ef37154b39bf0d}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a98bd83a14b359c994be9ab1bf4b8453b}
Output a description of the scatterer for P\-O\-V\-Ray. This should only be called by the \doxyref{Crystal}{p.}{a00027} Object to which belongs this scatterer. 

Implements {\bf Obj\-Cryst\-::\-Scatterer} \doxyref{}{p.}{a00092_a708cc857f82c9af4cbdf4d9334449d0f}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_aaa76da93619174b17db73de9d2374ac7}
...
Reimplemented from {\bf Obj\-Cryst\-::\-Refinable\-Obj} \doxyref{}{p.}{a00078_a01b02e566db9aebfd0f9ed2647441f40}.
...
\end{DoxyParamCaption}
)}\label{a00054_a7d3d1e583bc7d4beb1a8a6c7f74b4811}
...
This also removes all corresponding bonds, bond angles, etc... If del is true (default), then the \doxyref{Mol\-Atom}{p.}{a00050} object is deleted. The del flag gets sent to the Remove\-X\-X\-X functions for the corresponding objects. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Remove\-Bond@{Remove\-Bond}}
...
\item[{const bool}]{del = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_ad7cc4b6b9eec26f396fc30c517f37e24}
...
If del is true (default), then the \doxyref{Mol\-Bond}{p.}{a00051} object is deleted. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Remove\-Bond\-Angle@{Remove\-Bond\-Angle}}
...
\item[{const bool}]{del = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a113af00d52a1cc225803865a82f35512}


Remove a Bond\-Angle. 

If del is true (default), then the \doxyref{Mol\-Bond\-Angle}{p.}{a00052} object is deleted. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Remove\-Dihedral\-Angle@{Remove\-Dihedral\-Angle}}
...
\item[{const bool}]{del = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a3f95dc9df0a1547b07854773179d28be}


Remove a dihedral angle. 

If del is true (default), then the \doxyref{Mol\-Dihedral\-Angle}{p.}{a00053} object is deleted. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Remove\-Rigid\-Group@{Remove\-Rigid\-Group}}
...
\item[{const bool}]{del = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a0a2c86a36111f22e07356cac6364632a}


Remove a rigid group of atoms. 

See \doxyref{Molecule\-::mv\-Rigid\-Group}{p.}{a00054_a43939b3e3ad83065cf7ccb6065a53a12}

If del is true (default), then the \doxyref{Rigid\-Group}{p.}{a00089} object is deleted. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Reset\-Rigid\-Groups\-Par@{Reset\-Rigid\-Groups\-Par}}
...
{}
\end{DoxyParamCaption}
) const}\label{a00054_a9daa98a9b4a992d56e0dba41b104b291}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a560c9ffc36d4874b99eb26c198ee485f}


Add dihedral angles so as to rigidify the \doxyref{Molecule}{p.}{a00054}. 
...
\end{DoxyParamCaption}
)}\label{a00054_a9bd595a0ad88d6832718f3bffb452866}
...
\item[{const bool}]{keep\-Center = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a84e93db5b81b90fd5befa22caaf8691c}
...
\item[{const {\bf Mol\-Atom} \&}]{at}
\end{DoxyParamCaption}
)}\label{a00054_a24043736cd4323a31b7bc0fa6fa166da}
...
\item[{const bool}]{b}
\end{DoxyParamCaption}
)}\label{a00054_a19afb1f15773fed7a2d9dff35820bafd}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a91e2f80f1e4526fbb6cd99f5b229db9e}
...
Reimplemented from {\bf Obj\-Cryst\-::\-Refinable\-Obj} \doxyref{}{p.}{a00078_a3cb4cc924d39576618184eccd4321cf6}.
...
\item[{const bool}]{keep\-Center = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{a00054_a0d3122b53dd81aa23d2aaa2427e6291e}
...
{}
\end{DoxyParamCaption}
)}\label{a00054_a9cc198b9cb896d28c7bd90a775db4ec2}


Tune the rotation amplitude for free torsions and for the overall \doxyref{Molecule}{p.}{a00054} Rotation. 

This should be done after \doxyref{Molecule\-::\-Build\-Rotor\-Group()}{p.}{a00054_a3642fa8104faa1ce84a977600f9d1aeb}; \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!Update\-Display@{Update\-Display}}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_af1ae2c4f9febbe16019987f807271b58}
...
Reimplemented from {\bf Obj\-Cryst\-::\-Refinable\-Obj} \doxyref{}{p.}{a00078_ab74e2cead734fe1e652c5add46c5e116}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a701f78d93d495d1102d0bd26700c4a3d}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00054_a47762abe37f3e8f7378b7210916e71ea}
...
\paragraph[{m\-Auto\-Optimize\-Conformation}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Ref\-Obj\-Opt} Obj\-Cryst\-::\-Molecule\-::m\-Auto\-Optimize\-Conformation}\label{a00054_ae8459b9f767b0d8bc27b05140c604e0c}


Option to automatically optimize the starting conformation, if the total restraint cost is too high. 

This is done in \doxyref{Begin\-Optimization()}{p.}{a00054_a5fbdadb37966f382a6e33150285819dc}.
...
\paragraph[{m\-Connectivity\-Table}]{\setlength{\rightskip}{0pt plus 5cm}map$<${\bf Mol\-Atom} $\ast$,set$<${\bf Mol\-Atom} $\ast$$>$ $>$ Obj\-Cryst\-::\-Molecule\-::m\-Connectivity\-Table\hspace{0.3cm}{\ttfamily [mutable]}}\label{a00054_a13cffa530711a868859cfcfc17bce069}
...
\paragraph[{m\-Delete\-Sub\-Obj\-In\-Destructor}]{\setlength{\rightskip}{0pt plus 5cm}bool Obj\-Cryst\-::\-Molecule\-::m\-Delete\-Sub\-Obj\-In\-Destructor}\label{a00054_a5b35796cbf31728b39b82c36badaa97b}


Base Rotation amplitude (in radians) for the \doxyref{Molecule}{p.}{a00054}, so that the average atomic displacement is equal to 0.\-1 A. 
...
\paragraph[{m\-Flex\-Model}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Ref\-Obj\-Opt} Obj\-Cryst\-::\-Molecule\-::m\-Flex\-Model}\label{a00054_a35881bfb20092d0dcc424553f5671245}
...
\paragraph[{m\-Log\-Likelihood\-Scale}]{\setlength{\rightskip}{0pt plus 5cm}R\-E\-A\-L Obj\-Cryst\-::\-Molecule\-::m\-Log\-Likelihood\-Scale}\label{a00054_a7e69eecc5aa10a9908c3a6450cc2540b}
...
\paragraph[{m\-Optimize\-Orientation}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Ref\-Obj\-Opt} Obj\-Cryst\-::\-Molecule\-::m\-Optimize\-Orientation}\label{a00054_a8c82ea548f4c0f29e868776c88c5eab8}


Option to optimize the \doxyref{Molecule}{p.}{a00054}'s orientation. 

Useful to completely fix the \doxyref{Molecule}{p.}{a00054}. \index{Obj\-Cryst\-::\-Molecule@{Obj\-Cryst\-::\-Molecule}!m\-Quat@{m\-Quat}}
\index{m\-Quat@{m\-Quat}!ObjCryst::Molecule@{Obj\-Cryst\-::\-Molecule}}
\paragraph[{m\-Quat}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Quaternion} Obj\-Cryst\-::\-Molecule\-::m\-Quat}\label{a00054_a61b83701b288c4fdbcda97b14608af7d}
...
\paragraph[{m\-Scatt\-Comp\-List}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Scattering\-Component\-List} Obj\-Cryst\-::\-Molecule\-::m\-Scatt\-Comp\-List\hspace{0.3cm}{\ttfamily [mutable]}}\label{a00054_ae681f50b04c32c7139727c675dc04b67}
...
\paragraph[{mv\-Atom\-Bond}]{\setlength{\rightskip}{0pt plus 5cm}map$<${\bf Mol\-Atom}$\ast$ , std\-::vector$<${\bf Mol\-Bond}$\ast$$>$ $>$ Obj\-Cryst\-::\-Molecule\-::mv\-Atom\-Bond}\label{a00054_ad67f767fe62aeef49aef1c5760d69294}
...
\paragraph[{mvp\-Atom}]{\setlength{\rightskip}{0pt plus 5cm}vector$<${\bf Mol\-Atom}$\ast$$>$ Obj\-Cryst\-::\-Molecule\-::mvp\-Atom}\label{a00054_ad498c51ecf4ee0b4482e5fe41cd52be7}
...
\paragraph[{mvp\-Bond}]{\setlength{\rightskip}{0pt plus 5cm}vector$<${\bf Mol\-Bond}$\ast$$>$ Obj\-Cryst\-::\-Molecule\-::mvp\-Bond}\label{a00054_aabf6e0daf6f90f4052a44888f2bc3d7b}
...
\paragraph[{mvp\-Bond\-Angle}]{\setlength{\rightskip}{0pt plus 5cm}vector$<${\bf Mol\-Bond\-Angle}$\ast$$>$ Obj\-Cryst\-::\-Molecule\-::mvp\-Bond\-Angle}\label{a00054_a9c195054308e17604a24a3127e0cb307}
...
\paragraph[{mvp\-Dihedral\-Angle}]{\setlength{\rightskip}{0pt plus 5cm}vector$<${\bf Mol\-Dihedral\-Angle}$\ast$$>$ Obj\-Cryst\-::\-Molecule\-::mvp\-Dihedral\-Angle}\label{a00054_a21384a0b8be7bf3fc539c57d90d5c9a2}
...
\paragraph[{mv\-Rigid\-Group}]{\setlength{\rightskip}{0pt plus 5cm}std\-::vector$<${\bf Rigid\-Group}$\ast$$>$ Obj\-Cryst\-::\-Molecule\-::mv\-Rigid\-Group}\label{a00054_a43939b3e3ad83065cf7ccb6065a53a12}
...
\paragraph[{mv\-Ring}]{\setlength{\rightskip}{0pt plus 5cm}list$<${\bf Mol\-Ring}$>$ Obj\-Cryst\-::\-Molecule\-::mv\-Ring\hspace{0.3cm}{\ttfamily [mutable]}}\label{a00054_a35cb61305129b6bbda4a0bb014b2c90e}
...
\paragraph[{mv\-Rotor\-Group\-Internal}]{\setlength{\rightskip}{0pt plus 5cm}list$<${\bf Rotor\-Group}$>$ Obj\-Cryst\-::\-Molecule\-::mv\-Rotor\-Group\-Internal\hspace{0.3cm}{\ttfamily [mutable]}}\label{a00054_ac54d8a074549f7710a1823b0ecefcde8}
...
\paragraph[{mv\-Rotor\-Group\-Torsion}]{\setlength{\rightskip}{0pt plus 5cm}list$<${\bf Rotor\-Group}$>$ Obj\-Cryst\-::\-Molecule\-::mv\-Rotor\-Group\-Torsion\hspace{0.3cm}{\ttfamily [mutable]}}\label{a00054_afc51d36109a8d96a626f3c2251345c13}
...
\paragraph[{mv\-Rotor\-Group\-Torsion\-Single\-Chain}]{\setlength{\rightskip}{0pt plus 5cm}list$<${\bf Rotor\-Group}$>$ Obj\-Cryst\-::\-Molecule\-::mv\-Rotor\-Group\-Torsion\-Single\-Chain\hspace{0.3cm}{\ttfamily [mutable]}}\label{a00054_a22a07ddc2dbfeb90238b29bcca1e915d}
