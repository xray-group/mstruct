...
\label{a00020}\index{Obj\+Cryst\+::\+Cell\+Explorer@{Obj\+Cryst\+::\+Cell\+Explorer}}
...
\item 
{\bfseries Cell\+Explorer} (const {\bf Peak\+List} \&dhkl, const {\bf Crystal\+System} lattice, const unsigned int nb\+Spurious)\label{a00020_ab5812858db181b2da7793d50a0adf257}

\item 
void {\bfseries Evolution} (unsigned int ng, const bool randomize=true, const float f=0.\+7, const float cr=0.\+5, unsigned int np=100)\label{a00020_acef356378502e9c69fe03f92b02c0f36}

\item 
void {\bfseries Set\+Length\+Min\+Max} (const float min, const float max)\label{a00020_a637ca3e27ed5991e56e31c34e675bda3}

\item 
void {\bfseries Set\+Angle\+Min\+Max} (const float min, const float max)\label{a00020_a25a18c19322a421c3161b48330260e42}

\item 
void {\bfseries Set\+Volume\+Min\+Max} (const float min, const float max)\label{a00020_a6c729ec9156a394c54880470076e45b5}

\item 
void {\bfseries Set\+Nb\+Spurious} (const unsigned int nb)\label{a00020_a58cb7aaf7195b6263e4f950a810c0800}

\item 
void {\bf Set\+D2\+Error} (const float err)\label{a00020_a9f700330603affae619486c0b0a052d5}

\begin{DoxyCompactList}\small\item\em Allowed error on 1/d (squared!), used for dicvol. \end{DoxyCompactList}\item 
void {\bfseries Set\+Min\+Max\+Zero\+Shift} (const float min, const float max)\label{a00020_a91d0eedc650c3b4c2f062011b101fbd1}

\item 
void {\bfseries Set\+Crystal\+System} (const {\bf Crystal\+System} system)\label{a00020_a7b1dbaf22380e1ac581be1827930c9ba}

\item 
void {\bfseries Set\+Crystal\+Centering} (const Crystal\+Centering cent)\label{a00020_a37548d6bf7f5ff9b6908e097a830dc2c}
...
virtual const string \& {\bf Get\+Name} () const \label{a00020_a5d36f314bc0090493f29099eab7ce5ef}

\begin{DoxyCompactList}\small\item\em Name of the object. \end{DoxyCompactList}\item 
virtual void {\bfseries Print} () const \label{a00020_a87a517d92f81cd0ba5a92b0e1643c72c}

\item 
virtual unsigned int {\bf Get\+Nb\+L\+S\+Q\+Function} () const \label{a00020_a56aecc6855396e7377d6f346ed079661}

\begin{DoxyCompactList}\small\item\em Number of L\+S\+Q functions. \end{DoxyCompactList}\item 
virtual const Cryst\+Vector\+\_\+\+R\+E\+A\+L \& {\bf Get\+L\+S\+Q\+Calc} (const unsigned int) const \label{a00020_ac6c61fd4c10e37c0e7fa1850c3aaeeab}

\begin{DoxyCompactList}\small\item\em Get the current calculated value for the L\+S\+Q function. \end{DoxyCompactList}\item 
virtual const Cryst\+Vector\+\_\+\+R\+E\+A\+L \& {\bf Get\+L\+S\+Q\+Obs} (const unsigned int) const \label{a00020_aee7d3ae4beb8eefab9135a7232acc168}

\begin{DoxyCompactList}\small\item\em Get the observed values for the L\+S\+Q function. \end{DoxyCompactList}\item 
virtual const Cryst\+Vector\+\_\+\+R\+E\+A\+L \& {\bf Get\+L\+S\+Q\+Weight} (const unsigned int) const \label{a00020_a9609a2fc939138b683eb5897527710b8}
...
void {\bfseries L\+S\+Q\+Refine} (int nb\+Cycle=1, bool use\+Levenberg\+Marquardt=true, const bool silent=false)\label{a00020_a08259c076c61fef7e81fb69f7fc046dc}
...
float {\bfseries Get\+Best\+Score} () const \label{a00020_accd55684af9cc89c39066160181227b5}

\item 
const std\+::list$<$ std\+::pair\\*
$<$ {\bf Rec\+Unit\+Cell}, float $>$ $>$ \& {\bfseries Get\+Solutions} () const \label{a00020_a41c02ecb44040167fbd0e30525bc6907}

\item 
std\+::list$<$ std\+::pair\\*
$<$ {\bf Rec\+Unit\+Cell}, float $>$ $>$ \& {\bfseries Get\+Solutions} ()\label{a00020_ab2f61cb3f32e9cee000e5a59f616a905}

\end{DoxyCompactItemize}
\subsubsection*{Private Member Functions}
\begin{DoxyCompactItemize}
\item 
unsigned int {\bfseries R\+Dic\+Vol} ({\bf Rec\+Unit\+Cell} uc0, {\bf Rec\+Unit\+Cell} uc1, unsigned int depth, unsigned long \&nb\+Calc, const float min\+V, const float max\+V, vector$<$ unsigned int $>$ vdepth=vector$<$ unsigned int $>$())\label{a00020_a1fecb1e47c97a9d2b84a1e0183bb4fc9}

\item 
void {\bfseries Init} ()\label{a00020_ae4eeab6d7eff28c864fbb0fab58db600}
...
\item 
std\+::list$<$ std\+::pair\\*
$<$ {\bf Rec\+Unit\+Cell}, float $>$ $>$ {\bf mv\+Solution}\label{a00020_ac693e7aab9144b6758a7075faac67784}

\begin{DoxyCompactList}\small\item\em Max number of obs reflections to use. \end{DoxyCompactList}\item 
unsigned int {\bfseries mnpar}\label{a00020_aeded3ad11ac3eeebe6bb933995afd18a}

\item 
const {\bf Peak\+List} $\ast$ {\bfseries mp\+Peak\+List}\label{a00020_a77fcf4eec69d2a8fd1ac116e5b12cda6}

\item 
float {\bfseries m\+Length\+Min}\label{a00020_a70dc866b2aa3596f385dac228a7db100}

\item 
float {\bfseries m\+Length\+Max}\label{a00020_aedafc84b343e6bfb2942f5dc89b8cca0}

\item 
float {\bfseries m\+Angle\+Min}\label{a00020_ae430676622ff99e2e43f927b42069851}

\item 
float {\bfseries m\+Angle\+Max}\label{a00020_a0e4c7045d31b3dc7cc25613b7df862f0}

\item 
float {\bfseries m\+Volume\+Min}\label{a00020_ab16212bb24aea7b02997e1f80b0ab761}

\item 
float {\bfseries m\+Volume\+Max}\label{a00020_a870dd0600b26bee464e363a3d18d89f9}

\item 
float {\bfseries m\+Zero\+Shift\+Min}\label{a00020_afe0d6c6fb6aebd8d0779830b2b35bcbc}

\item 
float {\bfseries m\+Zero\+Shift\+Max}\label{a00020_adace9c5795be5c546b820c775cd44caf}

\item 
float {\bf m\+Min} [7]\label{a00020_acca81c2311cc37670e70339d6ebd3984}

\begin{DoxyCompactList}\small\item\em Min values for all parameters (7=unit cell +zero) \end{DoxyCompactList}\item 
float {\bf m\+Amp} [7]\label{a00020_ad90b6220e838b2b6cc1f56a962301be3}
...
{\bf Crystal\+System} {\bf mlattice}\label{a00020_a47fb489ee2fa1c6a1048893162411ec8}

\begin{DoxyCompactList}\small\item\em Lattice type for which we search. \end{DoxyCompactList}\item 
Crystal\+Centering {\bf m\+Centering}\label{a00020_a172a07f56757cb8fc2a8fb65fd8c3173}

\begin{DoxyCompactList}\small\item\em Centering type. \end{DoxyCompactList}\item 
unsigned int {\bfseries m\+Nb\+Spurious}\label{a00020_a50ba121b9d3ed4254992cb912e34b9c4}

\item 
float {\bfseries m\+D2\+Error}\label{a00020_a9b003761e823017903fb0f40b0924bc4}

\item 
{\bf L\+S\+Q\+Num\+Obj} {\bfseries m\+L\+S\+Q\+Obj}\label{a00020_a0d09ee2601d1159fad51218bfb67a5c7}

\item 
Cryst\+Vector\+\_\+\+R\+E\+A\+L {\bfseries m\+Obs}\label{a00020_ad255b0637307a261c8a492e7f345cc68}

\item 
Cryst\+Vector\+\_\+\+R\+E\+A\+L {\bfseries m\+Calc}\label{a00020_a487e252a8948812d7c71d9307dec2508}

\item 
Cryst\+Vector\+\_\+\+R\+E\+A\+L {\bfseries m\+Weight}\label{a00020_adaeb301383b51a7e6607f0d3d8b51539}

\item 
Cryst\+Vector\+\_\+\+R\+E\+A\+L {\bfseries m\+Deriv}\label{a00020_ac1dc395b436c64770fb25f562668e3dc}

\item 
{\bf Rec\+Unit\+Cell} {\bf m\+Rec\+Unit\+Cell}\label{a00020_ad1d07024afde6d58f4e17cf58c0a9365}

\begin{DoxyCompactList}\small\item\em Reciprocal unit cell used for least squares refinement. \end{DoxyCompactList}\item 
float {\bf m\+Best\+Score}\label{a00020_a354958f672e8c88b48eb1ebe9930be32}

\begin{DoxyCompactList}\small\item\em Current best score. \end{DoxyCompactList}\item 
std\+::vector$<$ unsigned int $>$ {\bf mv\+Nb\+Solution\+Depth}\label{a00020_ad0312849ee35af2f354e60f7ff5d951b}
...
float {\bfseries m\+Min\+Score\+Report}\label{a00020_a7bfdecf37010628aedc6cb0af0087f4c}

\item 
unsigned int {\bfseries m\+Max\+Dic\+Vol\+Depth}\label{a00020_ad0ccf6d8ce86f646b1e73ff35758e0a7}

\item 
unsigned int {\bfseries m\+Dic\+Vol\+Depth\+Report}\label{a00020_aba033e4b7608d69f9028524ecd3e62c6}

\item 
float {\bf m\+Cos\+Ang\+Max}\label{a00020_a42f12f0da01d8bb98d90369bf745dce4}
...
unsigned int {\bf m\+Nb\+L\+S\+Q\+Except}\label{a00020_a11c5a5dd196a163c5e04e4115462e8f8}
...
\index{Begin\+Optimization@{Begin\+Optimization}!Obj\+Cryst\+::\+Cell\+Explorer@{Obj\+Cryst\+::\+Cell\+Explorer}}
...
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00020_ae75ee0eb6652d5d43404b7205ec3cb94}
...
\doxyref{End\+Optimization()}{p.}{a00077_ab0035f6164cb24ace67b51b11993a851} must be called at the end of the optimization, the same number of time \doxyref{Begin\+Optimization()}{p.}{a00020_ae75ee0eb6652d5d43404b7205ec3cb94} was called !
\end{DoxyNote}
...
\index{Dic\+Vol@{Dic\+Vol}!Obj\+Cryst\+::\+Cell\+Explorer@{Obj\+Cryst\+::\+Cell\+Explorer}}
...
\end{DoxyParamCaption}
)}\label{a00020_adba0983c3b1dc6846ccf0d9ee7dbfa98}
...
\index{Get\+Class\+Name@{Get\+Class\+Name}!Obj\+Cryst\+::\+Cell\+Explorer@{Obj\+Cryst\+::\+Cell\+Explorer}}
\paragraph[{Get\+Class\+Name}]{\setlength{\rightskip}{0pt plus 5cm}virtual const string\& Obj\+Cryst\+::\+Cell\+Explorer\+::\+Get\+Class\+Name (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00020_a67ec6642b2a93030878764091178a0fb}
...
\index{Get\+L\+S\+Q\+Deriv@{Get\+L\+S\+Q\+Deriv}!Obj\+Cryst\+::\+Cell\+Explorer@{Obj\+Cryst\+::\+Cell\+Explorer}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00020_a6e4e1e3300bbf3e5f23900fccb135da3}
...
\index{Reduce\+Solutions@{Reduce\+Solutions}!Obj\+Cryst\+::\+Cell\+Explorer@{Obj\+Cryst\+::\+Cell\+Explorer}}
...
\end{DoxyParamCaption}
)}\label{a00020_ae32d743e1e6df33e09243cd7bb9a8c52}
