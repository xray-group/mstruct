...
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
{\tt The Blitz++ array library} (Todd Veldhuizen). This library is used for data storage and calculation in arrays and vectors. (Currently it is {\itshape not} used because of the huge memory requirements when compiling blitz++ expressions using the gcc compiler. Instead the \doxyref{Cryst\-Vector}{p.}{a00030} and \doxyref{Cryst\-Matrix}{p.}{a00029} are used, emulating the blitz interface, but without the smart handling of mathematical expressions.) Support for the Blitz++ should come back some time... 
\end{DoxyParagraph}
